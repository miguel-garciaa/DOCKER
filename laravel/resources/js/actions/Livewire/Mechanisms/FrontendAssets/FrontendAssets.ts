 ...
 * @route '/livewire-46639414/livewire.js'
 */
...
returnJavaScriptAsFile.definition = {
    methods: ["get","head"],
    url: '/livewire-46639414/livewire.js',
 ...
 * @route '/livewire-46639414/livewire.min.js.map'
 */
...
maps.definition = {
    methods: ["get","head"],
    url: '/livewire-46639414/livewire.min.js.map',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/livewire-46639414/livewire.csp.min.js.map'
 */
...
cspMaps.definition = {
    methods: ["get","head"],
    url: '/livewire-46639414/livewire.csp.min.js.map',
} satisfies RouteDefinition<["get","head"]>
