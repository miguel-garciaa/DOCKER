 ...
 * @route '/livewire-46639414/upload-file'
 */
...
uploadFile.definition = {
    methods: ["post"],
    url: '/livewire-46639414/upload-file',
 ...
 * @route '/livewire-46639414/preview-file/{filename}'
 */
...
previewFile.definition = {
    methods: ["get","head"],
    url: '/livewire-46639414/preview-file/{filename}',
