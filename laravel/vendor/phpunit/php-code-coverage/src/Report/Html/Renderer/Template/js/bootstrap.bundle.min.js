...
!(function (t, e) {
    ...
    class Rt extends W {
        ...
        _configAfterMerge(t) {
            return (
                (t.toggle = Boolean(t.toggle)), (t.parent = r(t.parent)), t
            );
        }
        _getDimension() {
                    ...
                    (function (t) {
                        ...
                        return (
                            'rtl' === Le(s || i).direction &&
                                (a +=
                                    we(i.clientWidth, s ? s.clientWidth : 0) -
                                    o),
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    (N.on(this._element, t, this._config.selector, (t) => {
                        ...
                        ((e._activeTrigger['focusin' === t.type ? ls : as] =
                            !0),
                            e._enter());
                    }),
