            ...
            async fn(t) {
                ...
                if (
                    ...
                    if (
                        ...
                        return {
                            data: { index: C, overflows: W },
                            reset: { placement: $ },
                        };
                    let _ =
                        (et = W.filter((Y) => Y.overflows[0] <= 0).sort(
    ...
    _onDragOver: function (t) {
        ...
        if (
            ...
            if (!O || (Yn(t, p, this) && !O.animated)) {
                ...
                (_t !== n &&
                    ((q = s[W]), (Zt = !1), (ue = (!M && a.invertSwap) || J)),
                    (L = Un(
                        t,
                        n,
                        s,
                ...
                if (L !== 0) {
                    var C = ot(u);
                    do ((C -= L), (V = P.children[C]));
                    while (V && (b(V, 'display') === 'none' || V === y));
                }
                if (L === 0 || V === n) return w(!1);
                ((_t = n), (Qt = L));
                ...
                if (Y !== !1)
                    return (
                        ...
                        (P = u.parentNode),
                        q !== void 0 && !ue && (me = Math.abs(q - B(n)[W])),
                        A(),
                        w(!0)
                    );
            }
...
function Jn() {
    ...
    return (
        (i.prototype = {
            ...
            nulling: function () {
                ((Ee = Xe = Ut = Ye = jt = He = We = null), (k.length = 0));
            },
                        ...
                        (k[d].pid = setInterval(
                            function () {
                                ...
                                (typeof h == 'function' &&
                                    ...
                                    Vi(k[this.layer].el, _, $);
                            }.bind({ layer: d }),
                            24,
                        )))),
                    d++);
            } while (t.bubbleScroll && f !== l && (f = xt(f, !1)));
            Ye = c;
        }
    }, 30),
    Gi = function (t) {
