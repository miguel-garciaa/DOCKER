(() => {
    ...
    function P(e) {
        let { x: t, y: o, width: n, height: r } = e;
        return {
            width: n,
            height: r,
            top: o,
    ...
    async function fe(e, t) {
        var o;
        t === void 0 && (t = {});
        let { x: n, y: r, platform: l, rects: i, elements: s, strategy: c } = e,
            {
            ...
            m = ce(f),
            w = s[h ? (u === 'floating' ? 'reference' : 'floating') : u],
            g = P(
    ...
    var Me = 50,
        de = async (e, t, o) => {
            let {
                ...
                s = i.detectOverflow ? i : { ...i, detectOverflow: fe },
            ...
            return { x: d, y: u, placement: h, strategy: r, middlewareData: m };
        };
    var $e = new Set(['left', 'top']);
    async function Ne(e, t) {
        let { placement: o, platform: n, elements: r } = e,
            l = await (n.isRTL == null ? void 0 : n.isRTL(r.floating)),
            i = Y(o),
            s = ee(o),
            c = z(o) === 'y',
            a = $e.has(i) ? -1 : 1,
        ...
        return (
            s && typeof m == 'number' && (f = s === 'end' ? m * -1 : m),
    ...
    var ue = function (e) {
            return (
                e === void 0 && (e = 0),
                {
                    ...
                    async fn(t) {
                        var o, n;
                        let { x: r, y: l, placement: i, middlewareData: s } = t,
                            c = await Ne(t, e);
                        return i ===
                            ((o = s.offset) == null ? void 0 : o.placement) &&
                            (n = s.arrow) != null &&
                            n.alignmentOffset
                            ? {}
                            : {
        ...
        he = function (e) {
            return (
                e === void 0 && (e = {}),
                {
                    ...
                    options: e,
                    async fn(t) {
                        let { x: o, y: n, placement: r, platform: l } = t,
                            {
                                mainAxis: i = !0,
                                crossAxis: s = !1,
                                limiter: c = {
    ...
    function Re(e) {
        let t = C(e),
            ...
            r = T(e),
            l = r ? e.offsetWidth : o,
            i = r ? e.offsetHeight : n,
            s = H(o) !== l || H(n) !== i;
        return (s && ((o = l), (n = i)), { width: o, height: n, $: s });
    }
    function oe(e) {
    ...
    function W(e) {
        ...
        let o = t.getBoundingClientRect(),
            { width: n, height: r, $: l } = Re(t),
            i = (l ? H(o.width) : o.width) / n,
            s = (l ? H(o.height) : o.height) / r;
        return (
    ...
    function Je(e, t, o) {
        ...
        l && !n && r && a();
        let d = r && !n && !l ? Oe(r, s) : O(0),
            u = i.left + s.scrollLeft - c.x - d.x,
            h = i.top + s.scrollTop - c.y - d.y;
    ...
    function Ze(e, t) {
        ...
        function i(s, c) {
            ...
            if ((s || t(), !h || !f)) return;
            let m = _(u),
                p = _(r.clientWidth - (d + h)),
                w = _(r.clientHeight - (u + f)),
                g = _(d),
                y = {
                    rootMargin:
                        -m + 'px ' + -p + 'px ' + -w + 'px ' + -g + 'px',
    ...
    function Le(e, t, o, n) {
        ...
        let {
            ...
            d = r || l ? [...(a ? V(a) : []), ...(t ? V(t) : [])] : [];
        d.forEach((g) => {
            (r && g.addEventListener('scroll', o, { passive: !0 }),
                l && g.addEventListener('resize', o));
        });
        let u = a && s ? Ze(a, o) : null,
            h = -1,
            f = null;
        i &&
        ...
        return (
            ...
            () => {
                var g;
                (d.forEach((x) => {
                    (r && x.removeEventListener('scroll', o),
    ...
    var De = ({
        ...
        selectRecords(i) {
            ...
            for (let s of i)
                if (!this.isRecordSelected(s)) {
                    if (this.isTrackingDeselectedRecords) {
                        this.deselectedRecords.delete(s);
                        continue;
                    }
                    this.selectedRecords.add(s);
                }
        ...
        deselectRecords(i) {
            for (let s of i) {
                if (this.isTrackingDeselectedRecords) {
                    this.deselectedRecords.add(s);
                    continue;
                }
                this.selectedRecords.delete(s);
            }
            this.updatedSelectedRecords();
        },
        ...
        canSelectAllRecords() {
            ...
            if (!i) return !1;
            let s = this.getSelectedRecordsCount();
            return i === s ? !1 : n === null || i <= n;
        },
        deselectAllRecords() {
        ...
        areRecordsSelected(i) {
            return i.every((s) => this.isRecordSelected(s));
        },
        areRecordsPartiallySelected(i) {
            if (i.length === 0) return !1;
            let s = i.filter((c) => this.isRecordSelected(c)).length;
            return s > 0 && s < i.length;
        },
        areRecordsToggleable(i) {
            if (n === null || n === 1) return !0;
            let s = i.filter((c) => this.isRecordSelected(c));
            return s.length === i.length
                ? !0
                : this.getSelectedRecordsCount() + (i.length - s.length) <= n;
        },
        ...
        watchForCheckboxClicks() {
            ...
            this.$root?.addEventListener(
                'click',
                (s) =>
                    s.target?.matches('.fi-ta-record-checkbox') &&
                    this.handleCheckboxClick(s, s.target),
                { signal: i },
            );
        },
        handleCheckboxClick(i, s) {
            if (!this.lastChecked) {
                this.lastChecked = s;
                return;
            }
            if (i.shiftKey) {
                ...
                if (s.checked) {
                    if (!this.areRecordsToggleable(h)) {
                        ((s.checked = !1), this.deselectRecords([s.value]));
                        return;
                    }
    ...
    function se({ columns: e, isLive: t }) {
        return {
            ...
            calculateGroupedColumns(o) {
                if ((o?.columns?.filter((s) => !s.isHidden) ?? []).length === 0)
                    return {
                        hidden: !0,
                        checked: !1,
                        disabled: !1,
                ...
                let r = o.columns.filter(
                    (s) => !s.isHidden && s.isToggleable !== !1,
                );
                if (r.length === 0)
                    return { checked: !0, disabled: !0, indeterminate: !1 };
                let l = r.filter((s) => s.isToggled).length,
                    i = o.columns.filter(
                        (s) => !s.isHidden && s.isToggleable === !1,
                    );
            ...
            getColumn(o, n = null) {
                return n
                    ...
                    : this.deferredColumns.find((r) => r.name === o);
            },
            toggleGroup(o) {
                ...
                if (!n?.columns) return;
                let r = this.calculateGroupedColumns(n);
                if (r.disabled) return;
                let i = n.columns
                        .filter((c) => c.isToggleable !== !1)
                        .some((c) => c.isToggled),
                    s = r.indeterminate ? !0 : !i;
                (n.columns
                    .filter((c) => c.isToggleable !== !1)
                    .forEach((c) => {
                        c.isToggled = s;
            ...
            toggleColumn(o, n = null) {
                let r = this.getColumn(o, n);
                !r ||
                    r.isToggleable === !1 ||
                    ((r.isToggled = !r.isToggled),
                    (this.deferredColumns = [...this.deferredColumns]),
                    this.isLive && this.applyTableColumnManager());
            },
            reorderColumns(o) {
                let n = o.map((r) => r.split('::'));
                (this.reorderTopLevel(n),
                    (this.hasReordered = !0),
                    this.isLive && this.applyTableColumnManager());
            },
            reorderGroupColumns(o, n) {
                let r = this.deferredColumns.find(
                    (s) => s.type === 'group' && s.name === n,
                );
                if (!r) return;
                let l = o.map((s) => s.split('::')),
                    i = [];
                (l.forEach(([s, c]) => {
                    let a = r.columns.find((d) => d.name === c);
                    a && i.push(a);
                }),
                    (r.columns = i),
                    (this.deferredColumns = [...this.deferredColumns]),
