(() => {
            ...
            if ((n && typeof n == 'object') || typeof n == 'function')
                for (let a of ie(n))
                    !ne.call(t, a) &&
                        ...
                        N(t, a, {
                            get: () => n[a],
                            enumerable: !(s = se(n, a)) || s.enumerable,
                        });
            return t;
        },
        le = (t) =>
            ...
            (function (s, a, m) {
                ...
                function B() {
                    if (!S) {
                        ...
                        for (var e in c)
                            (e > 95 && e < 112) ||
                                (c.hasOwnProperty(e) && (S[c[e]] = e));
                    }
                    return S;
                }
                function X(e, r, o) {
                    return (
                        o || (o = B()[e] ? 'keydown' : 'keypress'),
                        o == 'keypress' && r.length && (o = 'keydown'),
                        o
                    );
                }
                function Y(e) {
                ...
                function G(e, r) {
                    ...
                    for (o = Y(e), O = 0; O < o.length; ++O)
                        ((v = o[O]),
                            ...
                            P(v) && M.push(v));
                    return (
                        (r = X(v, M, r)), { key: v, modifiers: M, action: r }
                    );
                }
                function U(e, r) {
                    return e === null || e === a
                ...
                function w(e) {
                    var r = this;
                    if (((e = e || a), !(r instanceof w))) return new w(e);
                    ...
                    function q(i, l, p, f) {
                        r.stopCallback(l, l.target || l.srcElement, p, f) ||
                            (i(l, p) === !1 && (H(l), J(l)));
                    }
                    r._handleKey = function (i, l, p) {
                        var f = I(i, l, p),
                            d,
                            k = {},
                            u = 0,
                        ...
                        for (d = 0; d < f.length; ++d)
                            f[d].seq && (u = Math.max(u, f[d].level));
                        for (d = 0; d < f.length; ++d) {
                            if (f[d].seq) {
                                if (f[d].level != u) continue;
                                ((_ = !0),
                                    (k[f[d].seq] = 1),
                                    q(f[d].callback, p, f[d].combo, f[d].seq));
                                continue;
                            }
                            _ || q(f[d].callback, p, f[d].combo);
                        }
                    ...
                    function Q() {
                        (clearTimeout(v), (v = setTimeout(L, 1e3)));
                    }
                    function Z(i, l, p, f) {
                        o[i] = 0;
                        function d(A) {
                        ...
                        for (var u = 0; u < l.length; ++u) {
                            var _ = u + 1 === l.length,
                                C = _ ? k : d(f || G(l[u + 1]).action);
                            z(l[u], C, f, i, u);
                        }
                    }
                    function z(i, l, p, f, d) {
                        ((r._directMap[i + ':' + p] = l),
                            (i = i.replace(/\s+/g, ' ')));
                        var k = i.split(' '),
                            u;
                        ...
                        ((u = G(i, p)),
                            ...
                            I(u.key, u.modifiers, { type: u.action }, f, i, d),
                            r._callbacks[u.key][f ? 'unshift' : 'push']({
                                callback: l,
                    ...
                    ((r._bindMultiple = function (i, l, p) {
                        for (var f = 0; f < i.length; ++f) z(i[f], l, p);
                    }),
                        E(e, 'keypress', T),
                        E(e, 'keydown', T),
                        E(e, 'keyup', T));
                }
                ((w.prototype.bind = function (e, r, o) {
                    var v = this;
                    return (
                        (e = e instanceof Array ? e : [e]),
                        v._bindMultiple.call(v, e, r, o),
                        v
                    );
                }),
                    (w.prototype.unbind = function (e, r) {
                        var o = this;
                        return o.bind.call(o, e, function () {}, r);
                    }),
                    (w.prototype.trigger = function (e, r) {
                        var o = this;
                        return (
                            o._directMap[e + ':' + r] &&
                                o._directMap[e + ':' + r]({}, e),
                    ...
                    (w.prototype.stopCallback = function (e, r) {
                        var o = this;
                        if (
                    ...
                    w.init(),
                    (s.Mousetrap = w),
                    typeof n < 'u' && n.exports && (n.exports = w),
    ...
    (function (t) {
        if (t) {
            var n = {},
                s = t.prototype.stopCallback;
            ((t.prototype.stopCallback = function (a, m, c, y) {
                var h = this;
                return h.paused ? !0 : n[c] || n[y] ? !1 : s.call(h, a, m, c);
            }),
                (t.prototype.bindGlobal = function (a, m, c) {
                    var y = this;
                    if ((y.bind(a, m, c), a instanceof Array)) {
    ...
    var R = () =>
        ...
        pe = (t) => {
            t.directive(
                ...
                (
                    n,
                    { modifiers: s, expression: a },
                    { cleanup: m, evaluate: c },
                ) => {
                    let y = () => (a ? c(a) : n.click());
                    ((s = s.map((h) =>
                        h
                        ...
                        s.includes('global') &&
                            ((s = s.filter((h) => h !== 'global')),
                            K.default.bindGlobal(s, (h) => {
                                let g = R();
                                (g && !g.contains(n)) ||
                                    (h.preventDefault(), y());
                            })),
                        K.default.bind(s, (h) => {
                            let g = R();
                            (g && !g.contains(n)) || (h.preventDefault(), y());
                        }),
                        m(() => {
                            K.default.unbind(s);
                        }));
        ...
        setUpResizeObserver() {
            ...
            ((this.resizeObserver = new ResizeObserver(() => {
                ...
                (s && a
                    ...
                    : !s && m && (this.isOpen = this.isOpenDesktop),
                    (t = n));
            })),
    ...
    document.addEventListener('livewire:init', () => {
        Livewire.interceptRequest(
            ({ request: t, onError: n, onFailure: s }) => {
                (n(({ response: a, preventDefault: m }) => {
                    let c = window.filamentErrorNotifications;
                    if (!c) return;
                    try {
                        let g = t?.payload;
                        if (g && g.components.length === 1) {
                            for (let S of g.components)
                                if (
                                    JSON.parse(S.snapshot).data
    ...
    document.addEventListener('livewire:init', () => {
        window.Livewire.hook('component.init', ({ component: t }) => {
            t.el?.classList?.contains('fi-resource-create-record-page') &&
                t.snapshot?.data?.isCreating === !0 &&
                (t.$wire.isCreating = !1);
        });
    });
