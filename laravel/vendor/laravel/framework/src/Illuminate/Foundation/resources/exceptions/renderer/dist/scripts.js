...
function u(e) {
    (i.includes(e) || i.push(e), f());
}
function d(e) {
    let t = i.indexOf(e);
    t !== -1 && t > a && i.splice(t, 1);
}
function f() {
    if (!r && !n) {
        if (o) return;
        ((n = !0), queueMicrotask(p));
    }
}
function p() {
    ((n = !1), (r = !0));
    ...
    return [
        (n) => {
            ...
            return (
                ...
                e._x_effects.add(r),
                (t = () => {
                    r !== void 0 && (e._x_effects.delete(r), g(r));
                }),
                r
            );
        },
...
function M(e) {
    for (e._x_effects?.forEach(d); e._x_cleanups?.length;)
        e._x_cleanups.pop()();
}
var te = new MutationObserver(de),
    ne = !1;
function re() {
    (te.observe(document, {
        subtree: !0,
...
function ie() {
    (oe(), te.disconnect(), (ne = !1));
}
var ae = [];
function oe() {
    let e = te.takeRecords();
    ae.push(() => e.length > 0 && de(e));
    let t = ae.length;
    queueMicrotask(() => {
        if (ae.length === t) for (; ae.length > 0;) ae.shift()();
    });
}
function N(e) {
    if (!ne) return e();
...
function de(e) {
    ...
    for (let e of n) t.some((t) => t.contains(e)) || E.forEach((t) => t(e));
    for (let e of t) e.isConnected && D.forEach((t) => t(e));
    ...
    return (
        ...
        (e) => {
            if (typeof e == `object` && e && e._x_interceptor) {
                ...
                n.initialize = (r, i, a) => (
                    (n.initialValue = e.initialize(r, i, a)),
                    t(r, i, a)
                );
...
function xe(e, t, n) {
    ...
    else if (e[t[0]]) return xe(e[t[0]], t.slice(1), n);
    else return ((e[t[0]] = {}), xe(e[t[0]], t.slice(1), n));
}
var Se = {};
function P(e, t) {
    Se[e] = t;
...
function Ie(e, t) {
    ...
    F(n, e);
    let r = [n, ...me(e)],
        i = typeof t == `function` ? Le(r, t) : Be(r, t, e);
    return we.bind(null, e, t, i);
}
function Le(e, t) {
    return (
        n = () => {},
    ...
    let n = Object.getPrototypeOf(async function () {}).constructor,
        ...
        i = (() => {
            try {
                ...
                return (Te(n, t, e), Promise.resolve());
            }
        })();
    return ((Re[e] = i), i);
}
function Be(e, t, n) {
    ...
    return (
        ...
        if (typeof r == `function`) {
            let e = r.call(s, r, c).catch((e) => Te(e, n, t));
            r.finished
                ? (Ve(i, r.result, c, o, n), (r.result = void 0))
                : e
                      .then((e) => {
                          Ve(i, e, c, o, n);
                      })
...
function Ve(e, t, n, r, i) {
    if (ke && typeof t == `function`) {
        ...
        a instanceof Promise
            ? a.then((t) => Ve(e, t, n, r)).catch((e) => Te(e, i, t))
            : e(a);
    } else
...
function Ue(e, t, n = {}) {
    ...
    if (t.includes(`await`)) {
        ...
        return typeof r == `function` && ke ? r.apply(a, o) : r;
    }
}
var We = `x-`;
function Ge(e = ``) {
    ...
    return (
        (qe[e] = t),
        {
            before(t) {
                ...
                let n = ft.indexOf(t);
                ft.splice(n >= 0 ? n : ft.indexOf(`DEFAULT`), 0, e);
            },
        }
    );
}
...
function et(e) {
    ...
    (($e = t), Qe.set(t, []));
    let n = () => {
        for (; Qe.get(t).length;) Qe.get(t).shift()();
        Qe.delete(t);
    };
    (e(n), (Ze = !1), n());
}
...
function at(e = () => {}) {
    return ({ name: t, value: n }) => {
        let { name: r, value: i } = ot.reduce((e, t) => t(e), {
            name: t,
            value: n,
        });
...
function pt(e, t) {
    let n = ft.indexOf(e.type) === -1 ? dt : e.type,
        r = ft.indexOf(t.type) === -1 ? dt : t.type;
    return ft.indexOf(n) - ft.indexOf(r);
}
function mt(e, t, n = {}) {
    e.dispatchEvent(
        new CustomEvent(t, {
...
function ht(e, t) {
    if (typeof ShadowRoot == `function` && e instanceof ShadowRoot) {
        Array.from(e.children).forEach((e) => ht(e, t));
        return;
    }
    let n = !1;
    if ((t(e, () => (n = !0)), n)) return;
    let r = e.firstElementChild;
    for (; r;) (ht(r, t, !1), (r = r.nextElementSibling));
}
function R(e, ...t) {
...
function _t() {
    (gt &&
        ...
        Array.from(document.querySelectorAll(xt().join(`,`)))
            .filter((e) => !wt(e.parentElement, !0))
            .forEach((e) => {
                At(e);
            }),
...
function wt(e, t = !1) {
    return Tt(e, (e) => {
        if ((t ? xt() : bt()).some((t) => e.matches(t))) return !0;
    });
}
function Tt(e, t) {
    if (e) {
        ...
        if (
            ...
            return Tt(e.parentNode.host, t);
        if (e.parentElement) return Tt(e.parentElement, t);
    }
}
function Et(e) {
        ...
        Je(t) ||
            n.some((t) => {
                if (document.querySelector(t))
                    return (R(`found "${t}", but missing ${e} plugin`), !0);
            });
    });
}
var Nt = [],
...
L(
    ...
    (e, { value: t, modifiers: n, expression: r }, { evaluate: i }) => {
        (typeof r == `function` && (r = i(r)),
            r !== !1 &&
                (!r || typeof r == `boolean` ? qt(e, n, t) : Kt(e, r, t)));
    },
);
function Kt(e, t, n) {
    (Jt(e, Rt, ``),
...
function qt(e, t, n) {
    ...
    let o = !t.includes(`opacity`) && !t.includes(`scale`),
        ...
        l = +!s,
        u = c ? Qt(t, `scale`, 95) / 100 : 1,
        d = Qt(t, `delay`, 0) / 1e3,
        f = Qt(t, `origin`, `center`),
        p = `opacity, transform`,
        m = Qt(t, `duration`, 150) / 1e3,
        h = Qt(t, `duration`, 75) / 1e3,
...
function dn(e, t) {
    if (kn(e))
        (e.attributes.value === void 0 && (e.value = t),
            window.fromModel &&
                (typeof t == `boolean`
                    ? (e.checked = xn(e.value) === t)
                    : (e.checked = bn(e.value, t))));
    else if (On(e))
        Number.isInteger(t)
            ? (e.value = t)
            : !Array.isArray(t) &&
              ...
              ? (e.value = String(t))
              : Array.isArray(t)
                ? (e.checked = t.some((t) => bn(t, e.value)))
                : (e.checked = !!t);
...
function fn(e, t) {
    (e._x_undoAddedClasses && e._x_undoAddedClasses(),
        (e._x_undoAddedClasses = Rt(e, t)));
}
function pn(e, t) {
    (e._x_undoAddedStyles && e._x_undoAddedStyles(),
        (e._x_undoAddedStyles = Vt(e, t)));
}
function mn(e, t, n) {
    (hn(e, t, n), _n(e, t, n));
}
function hn(e, t, n) {
    [null, void 0, !1].includes(n) && wn(t)
        ? e.removeAttribute(t)
        : (Cn(t) && (n = t), gn(e, t, n));
}
function gn(e, t, n) {
...
function En(e, t, n, r = !0) {
    ...
    if (e._x_inlineBindings && e._x_inlineBindings[t] !== void 0) {
        ...
        return ((n.extract = r), Ae(() => je(e, n.expression)));
    }
    return Dn(e, t, n);
}
function Dn(e, t, n) {
...
var Fn = {},
    In = !1;
function Ln(e, t) {
    if (((In ||= ((Fn = m(Fn)), !0)), t === void 0)) return Fn[e];
    ((Fn[e] = t),
        ve(Fn[e]),
        typeof t == `object` &&
            t &&
...
var Kn = {
    ...
    version: `3.15.8`,
    flushAndStopDeferringMutations: ue,
    dontAutoEvaluateFunctions: Ae,
    disableEffectScheduling: y,
    startObservingMutations: re,
    stopObservingMutations: ie,
    setReactivityEngine: b,
    onAttributeRemoved: A,
    onAttributesAdded: ee,
    closestDataStack: me,
    skipDuringClone: en,
    onlyDuringClone: tn,
    addRootSelector: St,
...
var Yn = Object.prototype.hasOwnProperty,
    Xn = (e, t) => Yn.call(e, t),
    Zn = Array.isArray,
    Qn = (e) => rr(e) === `[object Map]`,
    $n = (e) => typeof e == `string`,
    er = (e) => typeof e == `symbol`,
    tr = (e) => typeof e == `object` && !!e,
...
var Er = qn(`__proto__,__v_isRef,__isVue`),
    Dr = new Set(
...
function Mr(e = !1, t = !1) {
    return function (n, r, i) {
        ...
        if (r === `__v_raw` && i === (e ? (t ? fi : di) : t ? ui : li).get(n))
            return n;
        let a = Zn(n);
        if (!e && a && Xn(Ar, r)) return Reflect.get(Ar, r, i);
        let o = Reflect.get(n, r, i);
        return (er(r) ? Dr.has(r) : Er(r)) || (e || wr(n, `get`, r), t)
            ? o
            : vi(o)
              ? !a || !ar(r)
                  ? o.value
...
function Pr(e = !1) {
    return function (t, n, r, i) {
        let a = t[n];
        if (!e && ((r = z(r)), (a = z(a)), !Zn(t) && vi(a) && !vi(r)))
            return ((a.value = r), !0);
        let o = Zn(t) && ar(n) ? Number(n) < t.length : Xn(t, n),
            s = Reflect.set(t, n, r, i);
        return (
            t === z(i) &&
                (o ? sr(r, a) && Tr(t, `set`, n, r, a) : Tr(t, `add`, n, r)),
            s
        );
    };
}
...
var Rr = { get: Or, set: Nr, deleteProperty: Fr, has: Ir, ownKeys: Lr },
    zr = {
        get: kr,
        set(e, t) {
            return (
...
function Jr(e, t) {
    ...
    return (
        n.set(e, t),
        a ? sr(t, o) && Tr(n, `set`, e, t, o) : Tr(n, `add`, e, t),
        this
    );
}
function Yr(e) {
    ...
    return (t, r, i) =>
        r === `__v_isReactive`
            ...
            : r === `__v_isReadonly`
              ...
              : r === `__v_raw`
                ? t
                : Reflect.get(Xn(n, r) && r in t ? n : t, r, i);
}
var oi = { get: ai(!1, !1) },
    si = { get: ai(!0, !1) };
function ci(e, t, n) {
...
(P(`nextTick`, () => Ft),
    ...
    P(`data`, (e) => fe(e)),
    P(`root`, (e) => wt(e)),
    P(`refs`, (e) => ((e._x_refs_proxy ||= he(yi(e))), e._x_refs_proxy)));
function yi(e) {
    let t = [];
    return (
        Tt(e, (e) => {
...
(P(`el`, (e) => e),
    Ti(`Focus`, `focus`, `focus`),
    Ti(`Persist`, `persist`, `persist`));
function Ti(e, t, n) {
    P(t, (r) =>
        R(
...
(L(
    ...
    L(`teleport`, (e, { modifiers: t, expression: n }, { cleanup: r }) => {
...
function ki(e, t, n, r) {
    ...
    if (
        ...
        let e = n[n.indexOf(`debounce`) + 1] || `invalid-wait`,
            t = Mi(e.split(`ms`)[0]) ? Number(e.split(`ms`)[0]) : 250;
        a = An(a, t);
    }
...
function Ii(e, t) {
    ...
    if (n.includes(`debounce`)) {
        ...
        n.splice(e, Mi((n[e + 1] || `invalid-wait`).split(`ms`)[0]) ? 2 : 1);
    }
    if (n.includes(`throttle`)) {
        let e = n.indexOf(`throttle`);
        n.splice(e, Mi((n[e + 1] || `invalid-wait`).split(`ms`)[0]) ? 2 : 1);
    }
    if (n.length === 0 || (n.length === 1 && Li(e.key).includes(n[0])))
        return !1;
    ...
    return (
        ...
        !(
            ...
            (Fi(e.type) || Li(e.key).includes(n[0]))
        )
    );
}
function Li(e) {
...
L(`model`, (e, { modifiers: t, expression: n }, { effect: r, cleanup: i }) => {
    let a = e;
    ...
    if ($t) m = () => {};
        ...
        let n = [],
            r = (n) => l(Ri(e, t, n, c()));
        if (
            (u && n.push(ki(e, `change`, t, r)),
            d && (n.push(ki(e, `blur`, t, r)), e.form))
        ) {
            let t = () => r({ target: e });
            (e.form._x_pendingModelUpdates ||
                (e.form._x_pendingModelUpdates = []),
                e.form._x_pendingModelUpdates.push(t),
                i(() =>
                    e.form._x_pendingModelUpdates.splice(
                        e.form._x_pendingModelUpdates.indexOf(t),
                        1,
                    ),
                ));
        }
    ...
    if (
        ...
        let n = ki(e.form, `reset`, [], (n) => {
            Ft(
                () =>
                    e._x_model && e._x_model.set(Ri(e, t, { target: e }, c())),
            );
        });
        i(() => n());
    }
...
(L(`cloak`, (e) =>
    queueMicrotask(() => N(() => e.removeAttribute(Ge(`cloak`)))),
),
    Ct(() => `[${Ge(`init`)}]`),
    L(
        `init`,
        en((e, { expression: t }, { evaluate: n }) =>
            typeof t == `string` ? !!t.trim() && n(t, {}, !1) : n(t, {}, !1),
        ),
    ),
    L(`text`, (e, { expression: t }, { effect: n, evaluateLater: r }) => {
        let i = r(t);
        n(() => {
            i((t) => {
                N(() => {
    ...
    L(`html`, (e, { expression: t }, { effect: n, evaluateLater: r }) => {
        let i = r(t);
        n(() => {
            i((t) => {
                N(() => {
...
((Ui.inline = (e, { value: t, modifiers: n, expression: r }) => {
    t &&
        ((e._x_inlineBindings ||= {}),
...
(St(() => `[${Ge(`data`)}]`),
    L(`data`, (e, { expression: t }, { cleanup: n }) => {
        if (Gi(e)) return;
        t = t === `` ? `{}` : t;
        let r = {};
        F(r, e);
        let i = {};
        Gn(i, r);
        let a = je(e, t, { scope: i });
        ((a === void 0 || a === !0) && (a = {}), F(a, e));
        let o = m(a);
        ve(o);
        let s = pe(e, o);
        (o.init && je(e, o.init),
            n(() => {
                (o.destroy && je(e, o.destroy), s());
            }));
    }),
    rn((e, t) => {
        e._x_dataStack &&
...
(L(`show`, (e, { modifiers: t, expression: n }, { effect: r }) => {
    let i = I(e, n);
    ((e._x_doHide ||= () => {
        N(() => {
            e.style.setProperty(
    ...
    L(`for`, (e, { expression: t }, { effect: n, cleanup: r }) => {
        let i = qi(t),
            a = I(e, i.items),
...
function Ki(e, t, n, r) {
    let i = (e) => typeof e == `object` && !Array.isArray(e),
        a = e;
    n((n) => {
        (Yi(n) && n >= 0 && (n = Array.from(Array(n).keys(), (e) => e + 1)),
            n === void 0 && (n = []));
        let o = e._x_lookup,
            s = e._x_prevKeys,
            c = [],
        ...
        if (i(n))
            n = Object.entries(n).map(([i, a]) => {
                ...
                (r(
                    (t) => {
                        (l.includes(t) && R(`Duplicate key on x-for`, e),
                            l.push(t));
                    },
                    { scope: { index: i, ...o } },
                ),
        ...
        for (let e = 0; e < l.length; e++) {
            let t = l[e],
                n = s.indexOf(t);
            if (n === -1) (s.splice(e, 0, t), u.push([h, e]));
            else if (n !== e) {
        ...
        for (let e = 0; e < d.length; e++) {
            ...
            (N(() => {
                (i || R(`x-for ":key" is undefined or invalid`, a, n, o),
                    i.after(s),
                    r.after(i),
                ...
                i._x_refreshXForScope(c[l.indexOf(n)]));
        }
        ...
        for (let e = 0; e < p.length; e++)
            o[p[e]]._x_refreshXForScope(c[l.indexOf(p[e])]);
        a._x_prevKeys = l;
    });
}
function qi(e) {
...
function Xi() {}
((Xi.inline = (e, { expression: t }, { cleanup: n }) => {
    let r = wt(e);
    ((r._x_refs ||= {}), (r._x_refs[t] = e), n(() => delete r._x_refs[t]));
}),
    L(`ref`, Xi),
    L(`if`, (e, { expression: t }, { effect: n, cleanup: r }) => {
        e.tagName.toLowerCase() !== `template` &&
            R(`x-if can only be used on a <template> tag`, e);
        let i = I(e, t),
            a = () => {
    ...
    L(`id`, (e, { expression: t }, { evaluate: n }) => {
    ...
    L(
        `on`,
        en((e, { value: t, modifiers: n, expression: r }, { cleanup: i }) => {
            let a = r ? I(e, r) : () => {};
            e.tagName.toLowerCase() === `template` &&
                ((e._x_forwardEvents ||= []),
    ...
    Zi(`Collapse`, `collapse`, `collapse`),
    Zi(`Intersect`, `intersect`, `intersect`),
    Zi(`Focus`, `trap`, `focus`),
    Zi(`Mask`, `mask`, `mask`));
function Zi(e, t, n) {
    L(t, (r) =>
...
(Kn.setEvaluator(Ie),
    Kn.setRawEvaluator(Ue),
    Kn.setReactivityEngine({ reactive: hi, effect: mr, release: hr, raw: z }));
var Qi = Kn,
    $i = `bottom`,
    ea = `right`,
    ta = `left`,
    ...
    sa = `popper`,
    ca = `reference`,
    la = ra.reduce(function (e, t) {
        return e.concat([t + `-` + ia, t + `-end`]);
    }, []),
    ua = [].concat(ra, [na]).reduce(function (e, t) {
        return e.concat([t, t + `-` + ia, t + `-end`]);
    }, []),
    da = [
        `beforeRead`,
        `read`,
...
function Ta(e, t, n) {
    ...
    t &&
        ma(e) &&
        ((i = (e.offsetWidth > 0 && Sa(r.width) / e.offsetWidth) || 1),
        (a = (e.offsetHeight > 0 && Sa(r.height) / e.offsetHeight) || 1));
    var o = (pa(e) ? B(e) : window).visualViewport,
        s = !wa() && n,
...
function Aa(e) {
    return ((pa(e) ? e.ownerDocument : e.document) || window.document)
        .documentElement;
}
function ja(e) {
    return fa(e) === `html`
        ? e
        : e.assignedSlot || e.parentNode || (ha(e) ? e.host : null) || Aa(e);
}
function Ma(e) {
    return !ma(e) || Oa(e).position === `fixed` ? null : e.offsetParent;
}
function Na(e) {
    var t = /firefox/i.test(Ca());
    if (/Trident/i.test(Ca()) && ma(e) && Oa(e).position === `fixed`)
        return null;
    var n = ja(e);
    for (ha(n) && (n = n.host); ma(n) && [`html`, `body`].indexOf(fa(n)) < 0;) {
        var r = Oa(n);
        if (
            r.transform !== `none` ||
            r.perspective !== `none` ||
...
function Pa(e) {
    for (var t = B(e), n = Ma(e); n && ka(n) && Oa(n).position === `static`;)
        n = Ma(n);
    return n &&
        (fa(n) === `html` || (fa(n) === `body` && Oa(n).position === `static`))
        ? t
        : n || Na(e) || t;
}
function Fa(e) {
...
function Ua(e) {
    ...
    r != null &&
        ((typeof r == `string` &&
            ...
            (Da(t.elements.popper, r) && (t.elements.arrow = r)));
}
var Wa = {
    name: `arrow`,
    enabled: !0,
...
function qa(e, t) {
    ...
    return { x: Sa(n * i) / i || 0, y: Sa(r * i) / i || 0 };
}
function Ja(e) {
    var t,
        n = e.popper,
    ...
    var D = Object.assign({ position: s }, l && Ka),
        O = u === !0 ? qa({ x: p, y: h }, B(n)) : { x: p, y: h };
    if (((p = O.x), (h = O.y), c)) {
        var k;
    ...
    return (
        a &&
            l.forEach(function (e) {
                e.addEventListener(`scroll`, n.update, Za);
            }),
        s && c.addEventListener(`resize`, n.update, Za),
        function () {
            (a &&
                l.forEach(function (e) {
                    e.removeEventListener(`scroll`, n.update, Za);
                }),
                s && c.removeEventListener(`resize`, n.update, Za));
        }
    );
}
var $a = {
...
function ao(e) {
    return Ta(Aa(e)).left + io(e).scrollLeft;
}
function oo(e, t) {
    var n = B(e),
        r = Aa(e),
    ...
    return { width: a, height: o, x: s + ao(e), y: c };
}
function so(e) {
    var t = Aa(e),
        n = io(e),
        ...
        s = -n.scrollTop;
    return (
        Oa(r || t).direction === `rtl` &&
            (o += ba(t.clientWidth, r ? r.clientWidth : 0) - i),
...
function lo(e) {
    return [`html`, `body`, `#document`].indexOf(fa(e)) >= 0
...
function uo(e, t) {
    ...
    var n = lo(e),
        ...
        i = B(n),
        a = r ? [i].concat(i.visualViewport || [], co(n) ? n : []) : n,
        o = t.concat(a);
    return r ? o : o.concat(uo(ja(a)));
}
function fo(e) {
...
function mo(e, t, n) {
    return t === `viewport` ? fo(oo(e, n)) : pa(t) ? po(t, n) : fo(so(Aa(e)));
}
function ho(e) {
    var t = uo(ja(e)),
        n =
            [`absolute`, `fixed`].indexOf(Oa(e).position) >= 0 && ma(e)
                ? Pa(e)
                : e;
    return pa(n)
        ? t.filter(function (e) {
              return pa(e) && Da(e, n) && fa(e) !== `body`;
          })
        : [];
}
function go(e, t, n, r) {
    var i = t === `clippingParents` ? ho(e) : [].concat(t),
        ...
        s = a.reduce(
            function (t, n) {
                var i = mo(e, n, r);
                return (
                    (t.top = ba(i.top, t.top)),
                    (t.right = xa(i.right, t.right)),
                    (t.bottom = xa(i.bottom, t.bottom)),
                    (t.left = ba(i.left, t.left)),
                    t
                );
            },
            mo(e, o, r),
...
function vo(e, t) {
    ...
    var n = t,
        ...
        h = n.padding,
        g = h === void 0 ? 0 : h,
        _ = za(typeof g == `number` ? Ba(g, ra) : g),
        v = f === `popper` ? ca : sa,
        y = e.rects.popper,
        b = e.elements[m ? v : f],
        x = go(pa(b) ? b : b.contextElement || Aa(e.elements.popper), c, u, o),
        S = Ta(e.elements.reference),
        C = _o({
            reference: S,
            element: y,
            strategy: `absolute`,
...
function wo(e) {
    return [`top`, ea, $i, ta].some(function (t) {
        return e[t] >= 0;
    });
}
function To(e) {
    var t = e.state,
        ...
        o = vo(t, { elementContext: `reference` }),
...
function Oo(e) {
    var t = e.state,
        ...
        i = n.offset,
        a = i === void 0 ? [0, 0] : i,
        o = ua.reduce(function (e, n) {
            return ((e[n] = Do(n, t.rects, a)), e);
        }, {}),
        s = o[t.placement],
        c = s.x,
        l = s.y;
...
function No(e) {
    var t = e.state,
        ...
        m = n.tetherOffset,
        h = m === void 0 ? 0 : m,
        g = vo(t, { boundary: c, rootBoundary: l, padding: d, altBoundary: u }),
        _ = ya(t.placement),
        v = Ga(t.placement),
        y = !v,
        b = Fa(_),
    ...
    if (S) {
        if (a) {
            var k = b === `y` ? `top` : ta,
                ...
                ie = v === `start` ? -w[A] : -C[A],
                ae = t.elements.arrow,
                oe = p && ae ? Ea(ae) : { width: 0, height: 0 },
                ...
                de = y
                    ...
                    : ie + le + ce + E.mainAxis,
                fe = t.elements.arrow && Pa(t.elements.arrow),
                pe = fe
                    ? b === `y`
                        ? fe.clientTop || 0
                        : fe.clientLeft || 0
                ...
                he = j + ue - me - pe,
                ge = j + de - me,
                _e = Ia(p ? xa(M, he) : M, j, p ? ba(te, ge) : te);
            ((S[b] = _e), (O[b] = _e - j));
        }
        if (s) {
            var ve = b === `x` ? `top` : ta,
                ...
                Se = be + g[ve],
                P = be - g[ye],
                F = [`top`, ta].indexOf(_) !== -1,
                Ce = D?.[x] ?? 0,
                we = F ? Se : be - C[xe] - w[xe] - Ce + E.altAxis,
                Te = F ? be + C[xe] + w[xe] - Ce - E.altAxis : P,
                Ee = p && F ? La(we, be, Te) : Ia(p ? we : Se, be, p ? Te : P);
            ((S[x] = Ee), (O[x] = Ee - be));
        }
        t.modifiersData[r] = O;
    }
...
function Io(e) {
    return e === B(e) || !ma(e) ? io(e) : Fo(e);
}
function Lo(e) {
    var t = e.getBoundingClientRect(),
        n = Sa(t.width) / e.offsetWidth || 1,
        r = Sa(t.height) / e.offsetHeight || 1;
    return n !== 1 || r !== 1;
}
function Ro(e, t, n) {
    n === void 0 && (n = !1);
    ...
    return (
        (r || (!r && !n)) &&
            ((fa(t) !== `body` || co(a)) && (s = Io(t)),
            ma(t)
                ? ((c = Ta(t, !0)), (c.x += t.clientLeft), (c.y += t.clientTop))
                : a && (c.x = ao(a))),
        {
        ...
        var i = {
            ...
            c = {
                ...
                setOptions: function (n) {
                    ...
                    var s = Bo(Ho([].concat(r, i.options.modifiers)));
                    return (
                        ...
                        if (Wo(t, n)) {
                            ((i.rects = {
                                ...
                                i.orderedModifiers.forEach(function (e) {
                                    return (i.modifiersData[e.name] =
                                        Object.assign({}, e.data));
                                }));
                            for (
                                var r = 0;
                                r < i.orderedModifiers.length;
                                r++
                            ) {
                                if (i.reset === !0) {
                                    ((i.reset = !1), (r = -1));
...
var Ko = Go({ defaultModifiers: [$a, jo, Xa, va, ko, So, Po, Wa, Eo] }),
    qo = `tippy-box`,
    Jo = `tippy-content`,
    Yo = `tippy-backdrop`,
    Xo = `tippy-arrow`,
    Zo = `tippy-svg-arrow`,
    Qo = { passive: !0, capture: !0 },
    $o = function () {
...
function ps(e) {
    return ts(e, `NodeList`);
}
function ms(e) {
    return ts(e, `MouseEvent`);
}
function hs(e) {
...
function gs(e) {
    return fs(e)
        ...
        : ps(e)
          ...
          : Array.isArray(e)
            ? e
            : ls(document.querySelectorAll(e));
}
function _s(e, t) {
    e.forEach(function (e) {
...
function Es() {
    ...
    (e - ws < 20 &&
        ((Cs.isTouch = !1), document.removeEventListener(`mousemove`, Es)),
        (ws = e));
}
function Ds() {
...
function Os() {
    (document.addEventListener(`touchstart`, Ts, Qo),
        window.addEventListener(`blur`, Ds));
}
var ks = typeof window < `u` && typeof document < `u` ? !!window.msCrypto : !1,
    As = Object.assign(
        {
            appendTo: $o,
...
function Ns(e) {
    var t = (e.plugins || []).reduce(function (t, n) {
        var r = n.name,
            i = n.defaultValue;
        return (r && (t[r] = e[r] === void 0 ? (As[r] ?? i) : e[r]), t);
    }, {});
    return Object.assign({}, e, t);
}
function Ps(e, t) {
    return (
        t ? Object.keys(Ns(Object.assign({}, As, { plugins: t }))) : js
    ).reduce(function (t, n) {
...
function Fs(e, t) {
    var n = Object.assign(
        {},
        t,
        { content: ns(t.content, [e]) },
        t.ignoreAttributes ? {} : Ps(e, t.plugins),
    );
    return (
        (n.aria = Object.assign({}, As.aria, n.aria)),
        (n.aria = {
            expanded:
...
function Rs(e) {
    ...
    return (
        e === !0
            ? (t.className = Xo)
            : ((t.className = Zo), fs(e) ? t.appendChild(e) : Ls(t, e)),
        t
    );
}
function zs(e, t) {
...
function Bs(e) {
    ...
    return {
        ...
        content: n.find(function (e) {
            return e.classList.contains(Jo);
        }),
        arrow: n.find(function (e) {
            return e.classList.contains(Xo) || e.classList.contains(Zo);
        }),
    ...
    function i(n, r) {
        ...
        (r.theme
            ...
            r.arrow
                ? s
                    ? n.arrow !== r.arrow &&
                      (a.removeChild(s), a.appendChild(Rs(r.arrow)))
...
var Hs = 1,
    ...
    Ws = [];
function Gs(e, t) {
    var n = Fs(e, Object.assign({}, As, Ns(us(t)))),
        r,
        i,
        a,
        o = !1,
    ...
    function te() {
        ...
        if (t.content) {
            var n = `aria-` + t.content,
                r = x.id;
            as(y.props.triggerTarget || e).forEach(function (e) {
    ...
    function re() {
        (k().removeEventListener(`mousemove`, m),
            (Us = Us.filter(function (e) {
                return e !== m;
            })));
    }
    function ie(t) {
        if (!(Cs.isTouch && (c || t.type === `mousedown`))) {
            var n = (t.composedPath && t.composedPath()[0]) || t.target;
            if (!(y.props.interactive && Ss(x, n))) {
                if (
                    as(y.props.triggerTarget || e).some(function (e) {
                        return Ss(e, n);
                    })
                ) {
                    if (
    ...
    function N() {
        var e = k();
        (e.addEventListener(`mousedown`, ie, !0),
            e.addEventListener(`touchend`, ie, Qo),
            e.addEventListener(`touchstart`, oe, Qo),
            e.addEventListener(`touchmove`, ae, Qo));
    }
    function se() {
        var e = k();
        (e.removeEventListener(`mousedown`, ie, !0),
            e.removeEventListener(`touchend`, ie, Qo),
            e.removeEventListener(`touchstart`, oe, Qo),
            e.removeEventListener(`touchmove`, ae, Qo));
    }
    function ce(e, t) {
        ue(e, function () {
            !y.state.isVisible &&
    ...
    function ue(e, t) {
        var n = ee().box;
        function r(e) {
            e.target === n && (xs(n, `remove`, r), t());
        }
        if (e === 0) return t();
        (xs(n, `remove`, d), xs(n, `add`, r), (d = r));
    }
    function de(t, n, r) {
        (r === void 0 && (r = !1),
            as(y.props.triggerTarget || e).forEach(function (e) {
    ...
    function fe() {
        (E() &&
            (de(`touchstart`, me, { passive: !0 }),
            de(`touchend`, ge, { passive: !0 })),
            is(y.props.trigger).forEach(function (e) {
                if (e !== `manual`)
                    switch ((de(e, me), e)) {
                        case `mouseenter`:
                            de(`mouseleave`, ge);
    ...
    function ge(e) {
        if (!(ve(e) || (y.props.trigger.indexOf(`click`) >= 0 && o))) {
    ...
    function ve(e) {
        return Cs.isTouch ? E() !== e.type.indexOf(`touch`) >= 0 : !1;
    }
    function ye() {
        be();
        var t = y.props,
    ...
    function Se() {
        return ls(x.querySelectorAll(`[data-tippy-root]`));
    }
    function P(e) {
    ...
    function Ee(t) {
        if (!y.state.isDestroyed) {
            (M(`onBeforeUpdate`, [y, t]), pe());
            var n = y.props,
                r = Fs(
                    e,
                    Object.assign({}, n, us(t), { ignoreAttributes: !0 }),
                );
            ((y.props = r),
                fe(),
                n.interactiveDebounce !== r.interactiveDebounce &&
                    (re(), (m = rs(he, r.interactiveDebounce))),
                n.triggerTarget && !r.triggerTarget
                    ? as(n.triggerTarget).forEach(function (e) {
                          e.removeAttribute(`aria-expanded`);
                      })
    ...
    function Oe() {
        var e = y.state.isVisible,
            ...
            n = !y.state.isEnabled,
            r = Cs.isTouch && !y.props.touch,
            i = es(y.props.duration, 0, As.duration);
        if (
            !(e || t || n || r) &&
            !O().hasAttribute(`disabled`) &&
            (M(`onShow`, [y], !1), y.props.onShow(y) !== !1)
        ) {
            if (
                ((y.state.isVisible = !0),
    ...
    function ke() {
        var e = !y.state.isVisible,
            t = y.state.isDestroyed,
            n = !y.state.isEnabled,
            r = es(y.props.duration, 1, As.duration);
        if (
            !(e || t || n) &&
            (M(`onHide`, [y], !1), y.props.onHide(y) !== !1)
        ) {
            if (
                ((y.state.isVisible = !1),
                (y.state.isShown = !1),
                ...
                var i = ee(),
                    a = i.box,
                    s = i.content;
                y.props.animation && (_s([a, s], r), vs([a, s], `hidden`));
            }
            (te(),
                ne(),
                y.props.animation ? D() && ce(r, y.unmount) : y.unmount());
        }
    }
    function Ae(e) {
        (k().addEventListener(`mousemove`, m), os(Us, m), m(e));
    }
    function je() {
        (y.state.isVisible && y.hide(),
            y.state.isMounted &&
...
function Ks(e, t) {
    t === void 0 && (t = {});
    var n = As.plugins.concat(t.plugins || []);
    Os();
    var r = Object.assign({}, t, { plugins: n }),
        i = gs(e).reduce(function (e, t) {
            var n = t && Gs(t, r);
            return (n && e.push(n), e);
        }, []);
    return fs(e) ? i[0] : i;
...
function Ys(e) {
    let t = [];
    for (let n = 0, r = e.length; n < r; n++) t[n] = Js(e[n]);
    return t;
}
function Xs(e) {
    let t = {};
    for (let n in e) t[n] = Js(e[n]);
    return t;
}
function Zs(e, ...t) {
    return (
...
function Qs(e) {
    ...
    return t === 0
        ? e
        : ~t === e.length - 1
          ? Qs(e.substring(0, e.length - 1))
          : e.substr(~t + 1);
}
var $s = /\$(\d+)|\${(\d+):\/(downcase|upcase)}/g,
    ec = class {
        static hasCaptures(e) {
            return e === null ? !1 : (($s.lastIndex = 0), $s.test(e));
        }
        static replaceCaptures(e, t, n) {
            return e.replace($s, (e, r, i, a) => {
...
var ac = class {
    ...
    oc = class {
        ...
        static createFromRawTheme(e, t) {
            return this.createFromParsedTheme(dc(e), t);
        }
        static createFromParsedTheme(e, t) {
            return pc(e, t);
        }
        _cachedMatchRoot = new ac((e) => this._root.match(e));
        getColorMap() {
        ...
        match(e) {
            ...
            let t = e.scopeName,
                n = this._cachedMatchRoot
                    .get(t)
                    .find((t) => cc(e.parent, t.parentScopes));
            return n ? new uc(n.fontStyle, n.foreground, n.background) : null;
        }
    },
    sc = class e {
        constructor(e, t) {
...
function pc(e, t) {
    e.sort((e, t) => {
        let n = tc(e.scope, t.scope);
        return n !== 0 || ((n = nc(e.parentScopes, t.parentScopes)), n !== 0)
            ? n
            : e.index - t.index;
    });
    let n = 0,
    ...
    let a = new mc(t),
        o = new uc(n, a.getId(r), a.getId(i)),
        s = new _c(new gc(0, null, -1, 0, 0), []);
    for (let t = 0, n = e.length; t < n; t++) {
        let n = e[t];
        s.insert(
            0,
...
var mc = class {
    ...
    _c = class e {
        ...
        insert(t, n, r, i, a, o) {
            ...
            (this._children.hasOwnProperty(c)
                ...
                : ((u = new e(
                      ...
                      gc.cloneArr(this._rulesWithParentScopes),
                  )),
                  (this._children[c] = u)),
        ...
        _doInsertHere(e, t, n, r, i) {
            ...
            for (
                let a = 0, o = this._rulesWithParentScopes.length;
                a < o;
                a++
            ) {
                let o = this._rulesWithParentScopes[a];
                if (nc(o.parentScopes, t) === 0) {
            ...
            (n === -1 && (n = this._mainRule.fontStyle),
                ...
                this._rulesWithParentScopes.push(new gc(e, t, n, r, i)));
        }
    },
    vc = class e {
    ...
    Oc = class {
        constructor(e, t) {
            ((this.repo = e),
                ...
                (this.Q = [new Tc(this.initialScopeName)]));
        }
        ...
        processQueue() {
            ...
            this.Q = [];
            let t = new Dc();
            for (let n of e) kc(n, this.initialScopeName, this.repo, t);
...
function kc(e, t, n, r) {
    ...
    let a = n.lookup(t);
    e instanceof Tc
        ? jc({ baseGrammar: a, selfGrammar: i }, r)
        : Ac(
              e.ruleName,
    ...
    if (o) for (let e of o) r.add(new Tc(e));
}
function Ac(e, t, n) {
...
function Mc(e, t, n) {
    for (let r of e) {
        ...
        n.visitedRule.add(r);
        let e = r.repository
            ? Zs({}, t.repository, r.repository)
            : t.repository;
        Array.isArray(r.patterns) && Mc(r.patterns, { ...t, repository: e }, n);
        let i = r.include;
        if (!i) continue;
        let a = Rc(i);
        switch (a.kind) {
            case 0:
                jc({ ...t, selfGrammar: t.baseGrammar }, n);
                break;
            case 1:
                jc(t, n);
                break;
            case 2:
                Ac(a.ruleName, { ...t, repository: e }, n);
                break;
            case 3:
            case 4:
                let r =
                ...
                if (r) {
                    ...
                    a.kind === 4 ? Ac(a.ruleName, i, n) : jc(i, n);
                } else
                    a.kind === 4
                        ? n.add(new Ec(a.scopeName, a.ruleName))
                        : n.add(new Tc(a.scopeName));
                break;
        }
    }
}
...
function Rc(e) {
    if (e === `$base`) return new Nc();
    if (e === `$self`) return new Pc();
    let t = e.indexOf(`#`);
    return t === -1
        ? new Ic(e)
        : t === 0
          ? new Fc(e.substring(1))
          : new Lc(e.substring(0, t), e.substring(t + 1));
}
var zc = /\\(\d+)/,
    Bc = /\\(\d+)/g,
    Vc = -1,
...
var Gc = class {
        ...
        constructor(e, t, n, r) {
            ((this.$location = e),
                (this.id = t),
                (this._name = n || null),
                (this._nameIsCapturing = ec.hasCaptures(this._name)),
                (this._contentName = r || null),
                (this._contentNameIsCapturing = ec.hasCaptures(
                    this._contentName,
                )));
        }
        get debugName() {
            let e = this.$location
                ? `${Qs(this.$location.filename)}:${this.$location.line}`
                : `unknown`;
        ...
        getName(e, t) {
            return !this._nameIsCapturing ||
                ...
                t === null
                ? this._name
                : ec.replaceCaptures(this._name, e, t);
        }
        getContentName(e, t) {
            return !this._contentNameIsCapturing || this._contentName === null
                ? this._contentName
                : ec.replaceCaptures(this._contentName, e, t);
        }
    },
    Kc = class extends Gc {
    ...
    Yc = class extends Gc {
        ...
        constructor(e, t, n, r, i, a, o, s, c, l) {
            (super(e, t, n, r),
                (this._begin = new Qc(i, this.id)),
                (this.beginCaptures = a),
                (this._end = new Qc(o || `￿`, -1)),
    ...
    Xc = class extends Gc {
        ...
        _getCachedCompiledWhilePatterns(e, t) {
            return (
                this._cachedCompiledWhilePatterns ||
                    ((this._cachedCompiledWhilePatterns = new $c()),
    ...
    Zc = class e {
        static createCaptureRule(e, t, n, r, i) {
            return e.registerRule((e) => new Kc(t, e, n, r, i));
        }
            ...
            return (
                t.id ||
                    n.registerRule((i) => {
                        ...
                        if (t.begin === void 0) {
                            t.repository && (r = Zs({}, r, t.repository));
                            let i = t.patterns;
                            return (
                                i === void 0 &&
                                    t.include &&
    ...
    Qc = class e {
        ...
        constructor(e, t) {
            ...
            (this.hasAnchor
                ...
                typeof this.source == `string`
                    ? (this.hasBackReferences = zc.test(this.source))
        ...
        resolveBackReferences(e, t) {
            ...
            return (
                (Bc.lastIndex = 0),
                this.source.replace(Bc, (e, t) => ic(n[parseInt(t, 10)] || ``))
            );
        }
        _buildAnchorCache() {
            if (typeof this.source != `string`)
...
`);
    ...
    nl = class e {
        ...
        constructor(e, t) {
            ((this._defaultAttributes = new tl(e, 8)),
                (this._embeddedLanguagesMatcher = new rl(
                    Object.entries(t || {}),
                )));
        }
        ...
        static _NULL_SCOPE_METADATA = new tl(0, 0);
        _getBasicScopeAttributes = new ac(
            (e) =>
                new tl(this._scopeToLanguage(e), this._toStandardTokenType(e)),
        );
        _scopeToLanguage(e) {
...
function ol(e, t, n, r, i, a, o, s) {
    ...
    let d = Date.now();
    for (; !l;) {
        if (s !== 0 && Date.now() - d > s) return new al(i, !0);
        f();
    }
    return new al(i, !1);
    function f() {
        let o = cl(e, t, n, r, i, u);
        if (!o) {
            (a.produce(i, c), (l = !0));
            return;
        }
        ...
        if (d === Vc) {
            ...
            if (
                ((i = i.push(d, r, u, s[0].end === c, null, h, h)),
                o instanceof Yc)
            ) {
                let r = o;
                (ml(e, t, n, i, a, r.beginCaptures, s),
                    a.produce(i, s[0].end),
                    (u = s[0].end));
...
function sl(e, t, n, r, i, a) {
    ...
    for (let t = i; t; t = t.pop()) {
        let n = t.getRule(e);
        n instanceof Xc && s.push({ rule: n, stack: t });
    }
    for (let c = s.pop(); c; c = s.pop()) {
        let { ruleScanner: s, findOptions: l } = fl(
                c.rule,
                e,
                c.stack.endRule,
                n,
        ...
        if (u) {
            ...
            u.captureIndices &&
                ...
                ml(e, t, n, c.stack, a, c.rule.whileCaptures, u.captureIndices),
...
function cl(e, t, n, r, i, a) {
    let o = ll(e, t, n, r, i, a),
        s = e.getInjections();
    if (s.length === 0) return o;
    let c = ul(s, e, t, n, r, i, a);
    if (!c) return o;
    if (!o) return c;
...
function ll(e, t, n, r, i, a) {
    let { ruleScanner: o, findOptions: s } = dl(
            i.getRule(e),
            e,
            i.endRule,
            n,
...
function ul(e, t, n, r, i, a, o) {
    ...
    for (let a = 0, f = e.length; a < f; a++) {
        ...
        let { ruleScanner: p, findOptions: m } = dl(
                t.getRule(f.ruleId),
                t,
                null,
                r,
...
function dl(e, t, n, r, i) {
    return il
        ? { ruleScanner: e.compile(t, n), findOptions: pl(r, i) }
        : { ruleScanner: e.compileAG(t, n, r, i), findOptions: 0 };
}
function fl(e, t, n, r, i) {
    return il
        ? { ruleScanner: e.compileWhile(t, n), findOptions: pl(r, i) }
...
function ml(e, t, n, r, i, a, o) {
    ...
    for (let t = 0; t < c; t++) {
        ...
        if (
            ...
            (ol(e, p, n && d.start === 0, d.start, f, i, !1, 0), wc(p));
            continue;
        }
        let f = c.getName(s, o);
        if (f !== null) {
...
function gl(e, t, n, r, i, a, o, s) {
    return new bl(e, t, n, r, i, a, o, s);
}
function _l(e, t, n, r, i) {
    let a = xc(t, vl),
        o = Zc.getCompiledRuleId(n, r, i.repository);
    for (let n of a)
        e.push({
            debugSelector: t,
            matcher: n.matcher,
...
var bl = class {
    constructor(e, t, n, r, i, a, o, s) {
        if (
            ...
            (this._onigLib = s),
            (this._basicScopeAttributesProvider = new nl(n, r)),
            (this._rootId = -1),
            (this._lastRuleId = 0),
            (this._ruleId2desc = [null]),
            (this._includedGrammars = {}),
            (this._grammarRepository = o),
            (this._grammar = xl(t, null)),
    ...
    _collectInjections() {
        ...
        if (r) {
            let e = r.injections;
            if (e) for (let n in e) _l(t, n, e[n], this, r);
    ...
    getExternalGrammar(e, t) {
        ...
        if (this._grammarRepository) {
            ...
            if (n)
                return (
                    (this._includedGrammars[e] = xl(n, t && t.$base)),
    ...
    _tokenize(e, t, n, r) {
        this._rootId === -1 &&
            ((this._rootId = Zc.getCompiledRuleId(
        ...
        if (!t || t === Cl.NULL) {
            ...
            let e = this._basicScopeAttributesProvider.getDefaultAttributes(),
                ...
                o;
            ((o = a
                ? Sl.createRootAndLookUpScopeName(a, r, this)
                : Sl.createRoot(`unknown`, r)),
                (t = new Cl(null, this._rootId, -1, -1, !1, null, o, o)));
        } else ((i = !1), t.reset());
        e += `
`;
...
var Sl = class e {
        ...
        static fromExtension(t, n) {
            let r = t,
                i = t?.scopePath ?? null;
            for (let t of n)
                ((i = sc.push(i, t.scopeNames)),
                    (r = new e(r, i, t.encodedTokenAttributes)));
            return r;
        }
        static createRoot(t, n) {
            return new e(null, new sc(null, t), n);
        }
        ...
        static mergeAttributes(e, t, n) {
            ...
            return (
                n !== null &&
                    ...
                    (i = n.foregroundId),
                    (a = n.backgroundId)),
                vc.set(e, t.languageId, t.tokenType, null, r, i, a)
            );
        }
        pushAttributed(t, n) {
    ...
    Cl = class e {
        ...
        static _equals(e, t) {
            return e === t
                ...
                : this._structuralEquals(e, t)
                  ? Sl.equals(e.contentNameScopesList, t.contentNameScopesList)
                  : !1;
        }
        ...
        static pushFrame(t, n) {
            ...
            return new e(
                ...
                n.endRule,
                r,
                Sl.fromExtension(r, n.contentNameScopesList),
            );
        }
    },
    wl = class {
            ...
            if (this._emitBinaryTokens) {
                ...
                if (
                    ...
                    for (let e of this._tokenTypeOverrides)
                        e.matcher(t) &&
                            (n = vc.set(n, 0, yc(e.type), null, -1, 0, 0));
                    this.balancedBracketSelectors &&
                        (r = this.balancedBracketSelectors.match(t));
                }
                if (
                    (r && (n = vc.set(n, 0, 8, r, -1, 0, 0)),
    ...
    El = class {
        ...
        grammarForScopeName(e, t, n, r, i) {
            if (!this._grammars.has(e)) {
                ...
                this._grammars.set(
                    e,
                    gl(e, a, t, n, r, i, this, this._onigLib),
                );
            }
    ...
    Dl = class {
        ...
        constructor(e) {
            ((this._options = e),
                (this._syncRegistry = new El(
                    oc.createFromRawTheme(e.theme, e.colorMap),
                    e.onigLib,
                )),
        ...
        setTheme(e, t) {
            this._syncRegistry.setTheme(oc.createFromRawTheme(e, t));
        }
        getColorMap() {
        ...
        _loadGrammar(e, t, n, r, i) {
            let a = new Oc(this._syncRegistry, e);
            for (; a.Q.length > 0;)
...
((Al.prototype.normal = {}),
    (Al.prototype.property = {}),
    (Al.prototype.space = void 0));
function jl(e, t) {
    let n = {},
        r = {};
...
var Rl = Object.keys(Nl),
    zl = class extends U {
        constructor(e, t, n, r) {
            let i = -1;
            if ((super(e, t), Bl(this, `space`, r), typeof n == `number`))
                for (; ++i < Rl.length;) {
                    let e = Rl[i];
                    Bl(this, Rl[i], (n & Nl[e]) === Nl[e]);
                }
        }
    };
zl.prototype.defined = !0;
function Bl(e, t, n) {
    n && (e[t] = n);
}
function Vl(e) {
    ...
    for (let [r, i] of Object.entries(e.properties)) {
        let a = new zl(r, e.transform(e.attributes || {}, r), i, e.space);
        (e.mustUseProperty &&
...
function $l(e, t) {
    ...
    if (n.length > 4 && n.slice(0, 4) === `data` && Ql.test(t)) {
        if (t.charAt(4) === `-`) {
            let e = t.slice(5).replace(Zl, tu);
            r = `data` + e.charAt(0).toUpperCase() + e.slice(1);
        } else {
            let e = t.slice(4);
            if (!Zl.test(e)) {
                let n = e.replace(Xl, eu);
...
var nu = jl([Hl, Gl, ql, Jl, Yl], `html`),
    ru = jl([Hl, Kl, ql, Jl, Yl], `svg`),
    iu = {}.hasOwnProperty;
function au(e, t) {
    let n = t || {};
    function r(t, ...n) {
...
var ou = /["&'<>`]/g,
    su = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
    cu = /[\x01-\t\v\f\x0E-\x1F\x7F\x81\x8D\x8F\x90\x9D\xA0-\uFFFF]/g,
    lu = /[|\\{}()[\]^$+*?.]/g,
    uu = new WeakMap();
function du(e, t) {
    if (
        ((e = e.replace(t.subset ? fu(t.subset) : ou, r)),
        t.subset || t.escapeOnly)
    )
        return e;
    return e.replace(su, n).replace(cu, r);
    function n(e, n, r) {
        return t.format(
...
function fu(e) {
    let t = uu.get(e);
    return (t || ((t = pu(e)), uu.set(e, t)), t);
}
function pu(e) {
    let t = [],
        n = -1;
    for (; ++n < e.length;) t.push(e[n].replace(lu, `\\$&`));
    return RegExp(`(?:` + t.join(`|`) + `)`, `g`);
}
var mu = /[\dA-Fa-f]/;
function hu(e, t, n) {
    let r = `&#x` + e.toString(16).toUpperCase();
    return n && t && !mu.test(String.fromCharCode(t)) ? r : r + `;`;
}
var gu = /\d/;
function _u(e, t, n) {
    let r = `&#` + String(e);
    return n && t && !gu.test(String.fromCharCode(t)) ? r : r + `;`;
}
var vu =
    ...
    bu = [`cent`, `copy`, `divide`, `gt`, `lt`, `not`, `para`, `times`],
    xu = {}.hasOwnProperty,
    Su = {},
    Cu;
for (Cu in yu) xu.call(yu, Cu) && (Su[yu[Cu]] = Cu);
var wu = /[^\dA-Za-z]/;
function Tu(e, t, n, r) {
    ...
    if (xu.call(Su, i)) {
        ...
        return n &&
            vu.includes(e) &&
            !bu.includes(e) &&
            (!r || (t && t !== 61 && wu.test(String.fromCharCode(t))))
            ? a
            : a + `;`;
    }
    return ``;
...
function ju(e, t, n, r) {
    return r.settings.bogusComments
        ? `<?` +
              ...
              `>`
        : `<!--` + e.value.replace(Ou, i) + `-->`;
    function i(e) {
        return Du(
            e,
            Object.assign({}, r.settings.characterReferences, { subset: Au }),
        );
    }
}
function Mu(e, t, n, r) {
...
function Vu(e) {
    return t;
    function t(t, n, r) {
        let i = t ? t.children : Bu,
            a = (n || 0) + e,
            o = i[a];
        if (!r) for (; o && Lu(o);) ((a += e), (o = i[a]));
        return o;
    }
}
var Hu = {}.hasOwnProperty;
function Uu(e) {
    return t;
    function t(t, n, r) {
        return Hu.call(e, t.tagName) && e[t.tagName](t, n, r);
    }
}
var Wu = Uu({
    body: qu,
...
function Gu(e, t, n) {
    ...
    return (
        !r ||
        (r.type !== `comment` && !(r.type === `text` && Lu(r.value.charAt(0))))
    );
}
function Ku(e, t, n) {
    let r = Y(n, t);
...
var od = Uu({ body: ld, colgroup: ud, head: cd, html: sd, tbody: dd });
function sd(e) {
    let t = Y(e, -1);
...
function ld(e) {
    ...
    return (
        !t ||
        (t.type !== `comment` &&
            !(t.type === `text` && Lu(t.value.charAt(0))) &&
            !(
                t.type === `element` &&
                (t.tagName === `meta` ||
                    t.tagName === `link` ||
...
function pd(e, t, n, r) {
    let i = r.schema,
        ...
        s = [],
        c;
    i.space === `html` && e.tagName === `svg` && (r.schema = ru);
    let l = md(r, e.properties),
        u = r.all(
    ...
    return n === !0 ||
        ...
        : (e.settings.preferUnquoted &&
              (s = Du(
                  ...
                  Object.assign({}, e.settings.characterReferences, {
                      attribute: !0,
                      subset: fd.unquoted[i][a],
                  }),
              )),
          s !== n &&
              (e.settings.quoteSmart &&
                  Nu(n, o) > Nu(n, e.alternative) &&
                  (o = e.alternative),
              (s =
                  o +
                  Du(
                      n,
                      Object.assign({}, e.settings.characterReferences, {
                          subset: (o === `'` ? fd.single : fd.double)[i][a],
                          attribute: !0,
                      }),
                  ) +
                  o)),
...
function _d(e, t, n, r) {
    return n &&
        ...
        : Du(
              e.value,
              Object.assign({}, r.settings.characterReferences, { subset: gd }),
          );
}
function vd(e, t, n, r) {
    return r.settings.allowDangerousHtml ? e.value : _d(e, t, n, r);
}
function yd(e, t, n, r) {
    return r.all(e);
}
...
function Ed(e, t) {
    ...
    return {
        ...
        settings: {
            ...
            voids: n.voids || kl,
            characterReferences: n.characterReferences || wd,
            closeSelfClosing: n.closeSelfClosing || !1,
            closeEmptyElements: n.closeEmptyElements || !1,
        },
        schema: n.space === `svg` ? ru : nu,
        quote: r,
        alternative: i,
    }.one(Array.isArray(e) ? { type: `root`, children: e } : e, void 0, void 0);
}
function Dd(e, t, n) {
    return bd(e, t, n, this);
}
function Od(e) {
    let t = [],
        n = (e && e.children) || Td,
        ...
        ? e.map((e) =>
              e.flatMap((e) => {
                  let t = n
                      ...
                      .map((t) => t - e.offset)
                      .sort((e, t) => e - t);
                  return t.length ? Hd(e, t) : e;
              }),
          )
        : e;
}
function Wd(e, t, n, r, i = `css-vars`) {
    let a = {
            content: e.content,
            explanation: e.explanation,
            offset: e.offset,
        },
        o = t.map((t) => Gd(e.variants[t])),
        s = new Set(o.flatMap((e) => Object.keys(e))),
        c = {},
        l = (e, r) => {
            let i =
                r === `color` ? `` : r === `background-color` ? `-bg` : `-${r}`;
...
function Gd(e) {
    ...
    if (
        ...
        (e.fontStyle & H.Italic && (t[`font-style`] = `italic`),
            e.fontStyle & H.Bold && (t[`font-weight`] = `bold`));
        let n = [];
        (e.fontStyle & H.Underline && n.push(`underline`),
            e.fontStyle & H.Strikethrough && n.push(`line-through`),
...
var Xd = class e {
    ...
    static initial(t, n) {
        return new e(Object.fromEntries(jd(n).map((e) => [e, Ol])), t);
    }
    constructor(...e) {
        if (e.length === 2) {
            let [t, n] = e;
...
function Qd(e, t) {
    if (!(e instanceof Xd)) throw new V(`Invalid grammar state`);
        ...
        if (!e.has(t.meta)) {
            let n = function (e) {
                    if (typeof e == `number`) {
                        ...
                        let n = e.character;
                        if (
                            (n < 0 && (n = t.length + n), n < 0 || n > t.length)
                        )
                            throw new V(
        ...
        code(e) {
            ...
            function i(e, t, n, i) {
                ...
                if (
                    (t === 0 && (c = 0),
                    n === 0 && (l = 0),
                    n === 1 / 0 && (l = a.children.length),
                    c === -1 || l === -1)
                )
                    for (let e = 0; e < a.children.length; e++)
                        ((s += tf(a.children[e])),
                            c === -1 && s.length === t && (c = e + 1),
                            l === -1 && s.length === n && (l = e + 1));
                if (c === -1)
                    throw new V(
                ...
                if (!i.alwaysWrap && u.length === a.children.length)
                    o(a, i, `line`);
                else if (
                    !i.alwaysWrap &&
                    u.length === 1 &&
            ...
            function o(e, t, n) {
                ...
                return (
                    ...
                    t.properties?.class && Ld(e, t.properties.class),
                    (e = i(e, n) || e),
                    e
                );
            }
            let s = [],
                c = n.decorations.sort(
                    (e, t) =>
                        t.start.offset - e.start.offset ||
                        e.end.offset - t.end.offset,
                );
            for (let e of c) {
                let { start: t, end: n } = e;
...
function tf(e) {
    return e.type === `text`
        ? e.value
        : e.type === `element`
          ? e.children.map(tf).join(``)
          : ``;
}
var nf = [$d()];
function rf(e) {
    let t = af(e.transformers || []);
    return [...t.pre, ...t.normal, ...t.post, ...nf];
}
function af(e) {
    let t = [],
        n = [],
    ...
    for (; e.length > 0;) {
        ...
        if (!Number.isNaN(r))
            if (r === 0) t.push({ type: `resetAll` });
                ...
                sf[r] && t.push({ type: `setDecoration`, value: sf[r] });
            else if (r <= 29) {
                let e = sf[r - 20];
                e &&
                    (t.push({ type: `resetDecoration`, value: e }),
                    e === `dim` &&
                        t.push({ type: `resetDecoration`, value: `bold` }));
            } else if (r <= 37)
                t.push({
                    type: `setForegroundColor`,
                    value: { type: `named`, name: of[r - 30] },
                });
            else if (r === 38) {
                let n = lf(e);
                    ...
                    : r === 53
                      ...
                      : r === 55
                        ...
                        : r >= 90 && r <= 97
                          ? t.push({
                                type: `setForegroundColor`,
                                value: { type: `named`, name: of[r - 90 + 8] },
                            })
                          : r >= 100 &&
                            r <= 107 &&
                            t.push({
                                type: `setBackgroundColor`,
                                value: { type: `named`, name: of[r - 100 + 8] },
                            });
    }
    return t;
}
...
function pf(e = ff) {
    ...
    function i() {
        if (r) return r;
        r = [];
        for (let e = 0; e < of.length; e++) r.push(t(of[e]));
    ...
    return i.map((t) =>
        o.parse(t[0]).map((n) => {
            ...
            (n.decorations.has(`reverse`)
                ...
                (i = Ad(i, r)),
                (o = Ad(o, r)),
                n.decorations.has(`dim`) && (i = gf(i)));
            let s = H.None;
            return (
                n.decorations.has(`bold`) && (s |= H.Bold),
                n.decorations.has(`italic`) && (s |= H.Italic),
                n.decorations.has(`underline`) && (s |= H.Underline),
                n.decorations.has(`strikethrough`) && (s |= H.Strikethrough),
                {
                    content: n.value,
                    offset: t[1],
                    color: i,
...
function _f(e, t, n = {}) {
    let { theme: r = e.getLoadedThemes()[0] } = n,
        i = e.resolveLangAlias(n.lang || `text`);
    if (Nd(i) || Fd(r))
        return Rd(t).map((e) => [{ content: e[0], offset: e[1] }]);
    let { theme: a, colorMap: o } = e.setTheme(r);
    if (i === `ansi`) return hf(a, t, n);
    let s = e.getLanguage(n.lang || `text`);
    if (n.grammarState) {
        if (n.grammarState.lang !== s.name)
            throw new V(
                `Grammar state language "${n.grammarState.lang}" does not match highlight language "${s.name}"`,
            );
...
function vf(...e) {
    if (e.length === 2) return Yd(e[1]);
    let [t, n, r = {}] = e,
        { lang: i = `text`, theme: a = t.getLoadedThemes()[0] } = r;
    if (Nd(i) || Fd(a))
        throw new V(`Plain language does not have grammar state`);
    if (i === `ansi`) throw new V(`ANSI language does not have grammar state`);
    let { theme: o, colorMap: s } = t.setTheme(a),
        c = t.getLanguage(i);
    return new Xd(bf(n, c, o, s, r).stateStack, c.name, o.name);
}
function yf(e, t, n, r, i) {
    let a = bf(e, t, n, r, i),
        o = new Xd(a.stateStack, t.name, n.name);
    return (Jd(a.tokens, o), a.tokens);
}
function bf(e, t, n, r, i) {
    let a = kd(n, i),
        ...
        c = Rd(e),
        l = i.grammarState
            ? (Qd(i.grammarState, n.name) ?? Ol)
            : i.grammarContextCode == null
              ? Ol
              : bf(i.grammarContextCode, t, n, r, {
                    ...i,
                    grammarState: void 0,
    ...
    for (let e = 0, f = c.length; e < f; e++) {
        ...
        if (o > 0 && f.length >= o) {
            ((u = []),
                d.push([{ content: f, offset: p, color: ``, fontStyle: 0 }]));
            continue;
        }
        let m, h, g;
...
function Sf(e, t) {
    ...
    for (let r = 0, i = t.length; r < i; r++) {
        let i = t[r];
        n[r] = { scopeName: i, themeMatches: Tf(e, i, t.slice(0, r)) };
    }
    return n;
}
function Cf(e, t) {
...
function wf(e, t, n) {
    if (!Cf(e[e.length - 1], t)) return !1;
    let r = e.length - 2,
        i = n.length - 1;
    for (; r >= 0 && i >= 0;) (Cf(e[r], n[i]) && --r, --i);
    return r === -1;
}
function Tf(e, t, n) {
    let r = [];
        ...
        s = i[0].state
            ? new Xd(
                  Object.fromEntries(
                      i.map((e) => [
                          e.theme,
                          e.state?.getInternalStack(e.theme),
                      ]),
                  ),
                  i[0].state.lang,
              )
...
function Of(e, t, n) {
    ...
    if (`themes` in n) {
        ...
        let p = Ef(e, t, n);
        if (((c = Yd(p)), l && Bd !== l && !f.find((e) => e.color === l)))
            throw new V(
                `\`themes\` option must contain the defaultColor key \`${l}\``,
            );
        let m = f.map((t) => e.getTheme(t.theme)),
            h = f.map((e) => e.color);
        ((a = p.map((e) => e.map((e) => Wd(e, h, u, l, d)))), c && Jd(a, c));
        let g = f.map((e) => kd(e.theme, n));
        ((i = kf(f, m, g, u, l, `fg`, d)),
            (r = kf(f, m, g, u, l, `bg`, d)),
            (o = `shiki-themes ${m.map((e) => e.name).join(` `)}`),
            (s = l ? void 0 : [i, r].join(`;`)));
    } else if (`theme` in n) {
        let s = kd(n.theme, n);
        a = _f(e, t, n);
        let l = e.getTheme(n.theme);
        ((r = Ad(l.bg, s)), (i = Ad(l.fg, s)), (o = l.name), (c = Yd(a)));
    } else
        throw new V(
...
function kf(e, t, n, r, i, a, o) {
    return e
        .map((s, c) => {
            let l = Ad(t[c][a], n[c]) || `inherit`,
                u = `${r + s.color}${a === `bg` ? `-bg` : ``}:${l}`;
            if (c === 0 && i) {
                if (i === Bd && e.length > 1) {
                    let r = e.findIndex((e) => e.color === `light`),
                        i = e.findIndex((e) => e.color === `dark`);
                    if (r === -1 || i === -1)
                        throw new V(
                            'When using `defaultColor: "light-dark()"`, you must provide both `light` and `dark` themes',
                        );
                    return `light-dark(${Ad(t[r][a], n[r]) || `inherit`}, ${Ad(t[i][a], n[i]) || `inherit`});${u}`;
                }
                return l;
            }
...
function Af(
    ...
    r = {
        meta: {},
        options: n,
        codeToHast: (t, n) => Af(e, t, n),
        codeToTokens: (t, n) => Of(e, t, n),
    },
) {
    let i = t;
    for (let e of rf(n)) i = e.preprocess?.call(r, i, n) || i;
    let {
            tokens: a,
            fg: o,
            bg: s,
    ...
    (d === !0 ? (a = Mf(a)) : d === `never` && (a = Nf(a)), f && (a = Pf(a)));
    let p = {
        ...r,
        get source() {
            return i;
    ...
    for (let e of rf(n)) a = e.tokens?.call(p, a) || a;
    return jf(
        a,
        {
            ...n,
    ...
    return e.map((e) => {
        ...
        return (
            e.forEach((i, a) => {
                let o = !(
                    i.fontStyle &&
                    (i.fontStyle & H.Underline || i.fontStyle & H.Strikethrough)
                );
...
function Pf(e) {
    return e.map((e) => {
        ...
        for (let n of e) {
            ...
            let e = t[t.length - 1],
                r = Kd(e.htmlStyle || Gd(e)),
                i = Kd(n.htmlStyle || Gd(n)),
                a =
                    e.fontStyle &&
                    (e.fontStyle & H.Underline ||
                        e.fontStyle & H.Strikethrough),
                o =
                    n.fontStyle &&
                    (n.fontStyle & H.Underline ||
                        n.fontStyle & H.Strikethrough);
...
function If(e, t, n) {
    let r = {
        ...
        i = Ff(Af(e, t, n, r));
    for (let e of rf(n)) i = e.postprocess?.call(r, i, n) || i;
    return i;
}
var Lf = { light: `#333333`, dark: `#bbbbbb` },
    Rf = { light: `#fffffe`, dark: `#1e1e1e` },
    zf = `__shiki_resolved`;
function Bf(e) {
    if (e?.[zf]) return e;
    let t = { ...e };
    ...
    if (!n || !r) {
        ...
        (e?.settings?.foreground && (r = e.settings.foreground),
            ...
            (r ||= t.type === `light` ? Lf.light : Lf.dark),
            (n ||= t.type === `light` ? Rf.light : Rf.dark),
            (t.fg = r),
            (t.bg = n));
    }
    ...
    t.settings = t.settings.map((e) => {
        let n =
                e.settings?.foreground &&
                !e.settings.foreground.startsWith(`#`),
            r =
                e.settings?.background &&
                !e.settings.background.startsWith(`#`);
        if (!n && !r) return e;
...
async function Hf(e) {
    return (
        await Promise.all(e.map(async (e) => (Id(e) ? null : Bf(await Md(e)))))
    ).filter((e) => !!e);
}
...
var Gf = class extends Dl {
        ...
        setTheme(e) {
            ...
            (t ||
                ((t = oc.createFromRawTheme(e)),
                this._textmateThemeCache.set(e, t)),
                this._syncRegistry.setTheme(t));
        }
        getGrammar(e) {
            return ((e = Wf(e, this._alias)), this._resolvedGrammars.get(e));
        }
        loadLanguage(e) {
            ...
            if (
                ...
                for (let e of t)
                    (this._resolvedGrammars.delete(e.name),
                        (this._loadedLanguagesCache = null),
                        this._syncRegistry?._injectionGrammars?.delete(
                            e.scopeName,
                        ),
        ...
        loadLanguages(e) {
            ...
            if (n.length) {
                let e = t
                    .filter(([e, t]) =>
                        t
                            ? (t.embeddedLanguages || t.embeddedLangs)?.some(
                                  (e) => n.map(([e]) => e).includes(e),
                              )
                            : !1,
                    )
...
function Jf(e) {
    ((qf += 1),
        e.warnings !== !1 &&
            ...
            qf % 10 == 0 &&
            console.warn(
                `[Shiki] ${qf} instances have been created. Shiki is supposed to be used as a singleton, consider refactoring your code to cache your highlighter instance; Or call \`highlighter.dispose()\` to release unused instances.`,
            ));
    let t = !1;
    if (!e.engine)
        throw new Uf('`engine` option is required for synchronous mode');
    let n = (e.langs || []).flat(1),
        r = (e.themes || []).flat(1).map(Bf),
        i = new Gf(new Kf(e.engine, n), r, n, e.langAlias),
        a;
    function o(t) {
        return Wf(t, e.langAlias);
    }
    function s(e) {
        g();
    ...
    async function h(...e) {
        return (g(), m(await Hf(e)));
    }
    function g() {
        if (t) throw new Uf(`Shiki instance has been disposed`);
    }
    function _() {
        t || ((t = !0), i.dispose(), --qf);
    }
...
function Yf(e) {
    let t = Jf(e);
    return {
        getLastGrammarState: (...e) => vf(t, ...e),
        codeToTokensBase: (e, n) => _f(t, e, n),
        codeToTokensWithThemes: (e, n) => Ef(t, e, n),
        codeToTokens: (e, n) => Of(t, e, n),
        codeToHast: (e, n) => Af(t, e, n),
        codeToHtml: (e, n) => If(t, e, n),
        getBundledLanguages: () => ({}),
        getBundledThemes: () => ({}),
        ...t,
...
var ep = X`\[\^?`,
    tp = `c.? | C(?:-.?)?|${X`[pP]\{(?:\^?[-\x20_]*[A-Za-z][-\x20\w]*\})?`}|${X`x[89A-Fa-f]\p{AHex}(?:\\x[89A-Fa-f]\p{AHex})*`}|${X`u(?:\p{AHex}{4})? | x\{[^\}]*\}? | x\p{AHex}{0,2}`}|${X`o\{[^\}]*\}?`}|${X`\d{1,3}`}`,
    np = /[?*+][?+]?|\{(?:\d+(?:,\d*)?|,\d+)\}\??/,
    rp = new RegExp(
        X`
  \\ (?:
...
function ap(e, t = {}) {
    ...
    let r = Fp(n.flags),
        ...
        o = [],
        s;
    for (rp.lastIndex = 0; (s = rp.exec(e));) {
        let t = op(a, e, s[0], rp.lastIndex);
        (t.tokens ? o.push(...t.tokens) : t.token && o.push(t.token),
            t.lastIndex !== void 0 && (rp.lastIndex = t.lastIndex));
    }
    let c = [],
        l = 0;
    (o
    ...
    return {
        tokens: o
            .map((e) => (e.type === `EscapedNumber` ? Lp(e, u) : e))
            .flat(),
        flags: r,
    };
}
function op(e, t, n, r) {
    ...
    if (i === `\\`) {
        if (`AbBGyYzZ`.includes(a)) return { token: dp(n, n) };
        if (/^\\g[<']/.test(n)) {
            if (!/^\\g(?:<[^>]+>|'[^']+')$/.test(n))
        ...
        if (a === `K`) return { token: yp(`keep`, n) };
        if (a === `N` || a === `R`)
            return { token: vp(`newline`, n, { negate: a === `N` }) };
        if (a === `O`) return { token: vp(`any`, n) };
        if (a === `X`) return { token: vp(`text_segment`, n) };
        let e = lp(n, { inCharClass: !1 });
        return Array.isArray(e) ? { tokens: e } : { token: e };
    }
    if (i === `(`) {
        if (a === `*`) return { token: Ap(n) };
        if (n === `(?{`) throw Error(`Unsupported callout "${n}"`);
        if (n.startsWith(`(?#`)) {
            if (t[r] !== `)`) throw Error(`Unclosed comment group "(?#"`);
            return { lastIndex: r + 1 };
        }
        if (/^\(\?[-imx]+[:)]$/.test(n)) return { token: kp(n, e) };
        if (
            (e.pushModX(e.getCurrentModX()),
            e.numOpenGroups++,
            (n === `(` && !e.captureGroup) || n === `(?:`)
        )
            return { token: Sp(`group`, n) };
        if (n === `(?>`) return { token: Sp(`atomic`, n) };
        if (n === `(?=` || n === `(?!` || n === `(?<=` || n === `(?<!`)
            return {
                token: Sp(n[2] === `<` ? `lookbehind` : `lookahead`, n, {
                    negate: n.endsWith(`!`),
                }),
            };
        if (
            ...
            return {
                token: Sp(`capturing`, n, {
                    ...(n !== `(` && { name: n.slice(3, -1) }),
                }),
            };
        if (n.startsWith(`(?~`)) {
            if (n === `(?~|`)
                throw Error(`Unsupported absence function kind "${n}"`);
            return { token: Sp(`absence_repeater`, n) };
        }
        throw Error(
            n === `(?(`
...
`,
        ...
        if (/^\s$/.test(n)) {
            let e = /\s+/y;
            return (
                (e.lastIndex = r), { lastIndex: e.exec(t) ? e.lastIndex : r }
            );
        }
    }
    return n === `.`
        ? { token: vp(`dot`, n) }
        : n === `^` || n === `$`
          ? { token: dp(e.singleline ? { '^': X`\A`, $: X`\Z` }[n] : n, n) }
          : n === `|`
            ? { token: up(n) }
            : np.test(n)
              ? { tokens: Rp(n) }
...
function sp(e, t, n) {
    let r = [_p(t[1] === `^`, t)],
        i = 1,
        a;
    for (ip.lastIndex = n; (a = ip.exec(e));) {
        let e = a[0];
        if (e[0] === `[` && e[1] !== `:`) (i++, r.push(_p(e[1] === `^`, e)));
        else if (e === `]`) {
            if (r.at(-1).type === `CharacterClassOpen`) r.push(pp(93, e));
            else if ((i--, r.push(mp(e)), !i)) break;
        } else {
            let t = cp(e);
            Array.isArray(t) ? r.push(...t) : r.push(t);
        }
    }
    return { tokens: r, lastIndex: ip.lastIndex || e.length };
}
function cp(e) {
    if (e[0] === `\\`) return lp(e, { inCharClass: !0 });
    if (e[0] === `[`) {
        let t = /\[:(?<negate>\^?)(?<name>[a-z]+):\]/.exec(e);
        if (!t || !Qf.has(t.groups.name))
            throw Error(`Invalid POSIX class "${e}"`);
        return vp(`posix`, e, {
            value: t.groups.name,
            negate: !!t.groups.negate,
        });
    }
    return e === `-` ? hp(e) : e === `&&` ? gp(e) : pp(Xf(e), e);
}
function lp(e, { inCharClass: t }) {
    let n = e[1];
    if (n === `c` || n === `C`) return Op(e);
    if (`dDhHsSwW`.includes(n)) return Mp(e);
    if (e.startsWith(X`\o{`))
        throw Error(
        ...
        try {
            let t = e
                ...
                n = new TextDecoder(`utf-8`, {
                    ignoreBOM: !0,
                    fatal: !0,
                }).decode(new Uint8Array(t)),
                r = new TextEncoder();
            return [...n].map((e) => {
                let t = [...r.encode(e)]
                    .map((e) => `\\x${e.toString(16)}`)
                    .join(``);
                return pp(Xf(e), t);
            });
        } catch {
    ...
    if (n === `u` || n === `x`) return pp(Ip(e), e);
    if (Dp.has(n)) return pp(Dp.get(n), e);
    if (/\d/.test(n)) return bp(t, e);
    if (e === `\\`) throw Error(X`Incomplete escape "\"`);
    if (n === `M`) throw Error(`Unsupported meta "${e}"`);
    if ([...e].length === 2) return pp(e.codePointAt(1), e);
...
function yp(e, t, n = {}) {
    return e === `keep`
        ...
        : { type: `Directive`, kind: e, flags: $f(n.flags), raw: t };
}
function bp(e, t) {
...
function Op(e) {
    ...
    return pp(Xf(t.toUpperCase()) - 64, e);
}
function kp(e, t) {
    ...
    if ((a && (s.enable = a), o && (s.disable = o), e.endsWith(`)`)))
        return (t.replaceCurrentModX(i), yp(`flags`, e, { flags: s }));
    if (e.endsWith(`:`))
        return (
            t.pushModX(i),
            t.numOpenGroups++,
            Sp(`group`, e, { ...((a || o) && { flags: s }) })
        );
...
function Ap(e) {
    ...
    let a = i
            ...
            : [],
        [o, s, c] = a,
        l = Ep.has(n) ? n.toLowerCase() : `custom`;
    switch (l) {
        case `fail`:
        case `mismatch`:
        case `skip`:
        ...
        case `max`:
            if (!a.length || a.length > 2)
                throw Error(
                    `Named callout must have one or two arguments "${a}"`,
                );
    ...
    return Cp(l, r ?? null, i?.split(`,`) ?? null, e);
}
function jp(e) {
    let t = null,
        n,
...
function Mp(e) {
    ...
    return vp({ d: `digit`, h: `hex`, s: `space`, w: `word` }[t], e, {
        negate: e[1] !== t,
    });
}
function Np(e) {
...
function Fp(e) {
    ...
    for (let n = 0; n < e.length; n++) {
        ...
        if (r === `y`) {
            ...
            ((t.textSegmentMode = e[n + 2] === `g` ? `grapheme` : `word`),
                (n += 3));
            continue;
        }
        t[
...
function Ip(e) {
    if (
        /^(?:\\u(?!\p{AHex}{4})|\\x(?!\p{AHex}{1,2}|\{\p{AHex}{1,8}\}))/u.test(
            e,
        )
    )
    ...
    for (let e = 0; e < o.length; e++) {
        ...
        if (e === 0 && t !== `8` && t !== `9`) {
            if (((r = parseInt(t, 8)), r > 127))
                throw Error(X`Octal encoded byte above 177 unsupported "${n}"`);
        } else r = Xf(t);
        a.push(pp(r, (e === 0 ? `\\` : ``) + t));
    }
    return a;
    ...
    for (; (r = n.exec(e));) {
        ...
        if (e[0] === `{`) {
            ...
            if (r) {
                ...
                if (+i > +a && e.endsWith(`?`)) {
                    (n.lastIndex--, t.push(jp(e.slice(0, -1))));
                    continue;
                }
            }
        }
...
function Hp(e, t = {}) {
    let n = {
        ...
        i = (e, t) => {
            ...
            switch (((a.parent = e), a.nextIndex++, n.type)) {
                ...
                case `Character`:
                    return nm(n.value, {
                        useLastValid: !!t.isCheckingRangeEnd,
                    });
                ...
                case `CharacterSet`:
                    return qp(n, a);
                case `Directive`:
                    return om(n.kind, { flags: n.flags });
                case `GroupOpen`:
                    return Jp(n, a, t);
                case `NamedCallout`:
                    return um(n.kind, n.tag, n.arguments);
                case `Quantifier`:
                    return Yp(n, a);
                case `Subroutine`:
                    return Xp(n, a);
    ...
    for (let { ref: e } of d)
        if (typeof e == `number`) {
            if (e > c.length)
                throw Error(
                    `Subroutine uses a group number that's not defined`,
                );
            e && (c[e - 1].isSubroutined = !0);
        } else if (u.has(e)) {
            if (u.get(e).length > 1)
                throw Error(
                    X`Subroutine uses a duplicate group name "\g<${e}>"`,
                );
            u.get(e)[0].isSubroutined = !0;
        } else
            throw Error(
                X`Subroutine uses a group name that's not defined "\g<${e}>"`,
            );
    return o;
}
function Up({ kind: e }) {
...
function Wp({ raw: e }, t) {
    let n = /^\\k[<']/.test(e),
        ...
        i = (n, r = !1) => {
            ...
            return (
                (t.hasNumberedRef = !0), em(r ? i + 1 - n : n, { orphan: a })
            );
        };
    if (n) {
...
function Gp(e, t, n) {
    ...
    if (
        ...
        if (o.type === `Character` && e.type === `Character`)
            return (a.body.pop(), im(o, e));
        throw Error(`Invalid character class range`);
    }
    return nm(Xf(`-`));
}
function Kp({ negate: e }, t, n) {
    let { tokens: r, walk: i } = t,
        a = r[t.nextIndex],
        o = [rm()],
        s = wm(a);
    for (; s.type !== `CharacterClassClose`;) {
        if (s.type === `CharacterClassIntersector`)
            (o.push(rm()), t.nextIndex++);
        else {
            let e = o.at(-1);
            e.body.push(i(e, n));
        }
        s = wm(r[t.nextIndex], a);
    }
    let c = rm({ negate: e });
    return (
        o.length === 1
...
function qp({ kind: e, negate: t, value: n }, r) {
    let {
    ...
    if (e === `property`) {
        let r = Cm(n);
        if (Qf.has(r) && !o?.has(r)) ((e = `posix`), (n = r));
        else
            return hm(n, {
                negate: t,
                normalizeUnknownPropertyNames: i,
    ...
    return e === `posix` ? dm(n, { negate: t }) : am(e, { negate: t });
}
function Jp(e, t, n) {
    let {
            tokens: r,
        ...
        if (f.type === `Alternator`) (c.body.push(Qp()), t.nextIndex++);
            ...
            if ((e.body.push(t), (u || n.isInLookbehind) && !o)) {
                ...
                if (d || n.isInNegLookbehind) {
                    if (ym(t) || t.type === `CapturingGroup`) throw Error(e);
                } else if (ym(t) || (bm(t) && t.negate)) throw Error(e);
            }
        }
        f = Tm(r[t.nextIndex]);
    }
...
function Yp({ kind: e, min: t, max: n }, r) {
    let i = r.parent,
        a = i.body.at(-1);
    if (!a || !Bp(a)) throw Error(`Quantifier requires a repeatable token`);
    let o = fm(e, t, n, a);
    return (i.body.pop(), o);
}
function Xp({ raw: e }, t) {
...
function Zp(e, t) {
    if (e !== `repeater`)
        throw Error(`Unexpected absence function kind "${e}"`);
    return { type: `AbsenceFunction`, kind: e, body: _m(t?.body) };
}
function Qp(e) {
    return { type: `Alternative`, body: vm(e?.body) };
}
function $p(e, t) {
...
function om(e, t = {}) {
    ...
    if (e === `flags`)
        return { type: `Directive`, kind: e, flags: $f(t.flags) };
...
function dm(e, t) {
    let n = !!t?.negate;
    if (!Qf.has(e)) throw Error(`Invalid POSIX class "${e}"`);
...
function pm(e, t) {
    return { type: `Regex`, body: _m(t?.body), flags: e };
}
function mm(e) {
...
function hm(e, t) {
    let n = {
        ...
        r = n.unicodePropertyMap?.get(Cm(e));
    if (!r) {
        if (n.normalizeUnknownPropertyNames) r = Sm(e);
        else if (n.unicodePropertyMap && !n.skipPropertyNameValidation)
            throw Error(X`Invalid Unicode property "\p{${e}}"`);
    }
    return {
        type: `CharacterSet`,
        kind: `property`,
...
function gm({ flags: e, kind: t, name: n, negate: r, number: i }) {
    switch (t) {
        ...
        case `lookahead`:
        case `lookbehind`:
            return lm({ behind: t === `lookbehind`, negate: r });
        default:
    ...
    function i(a, o = null, s = null, c = null) {
        let l = 0,
            ...
            d = {
                ...
                root: e,
                remove() {
                    (Dm(c).splice(Math.max(0, Om(s) + l), 1), l--, (u = !0));
                },
                removeAllNextSiblings() {
                    return Dm(c).splice(Om(s) + 1);
                },
                removeAllPrevSiblings() {
                    let e = Om(s) + l;
                    return ((l -= e), Dm(c).splice(0, Math.max(0, e)));
                },
                replaceWith(e, t = {}) {
                    let n = !!t.traverse;
                    (c
                        ? (c[Math.max(0, Om(s) + l)] = e)
                        : ($f(o, `Can't replace root node`)[s] = e),
                        n && i(e, o, s, c),
                        (u = !0));
                },
                replaceWithMultiple(e, t = {}) {
                    let n = !!t.traverse;
                    if (
                        (Dm(c).splice(Math.max(0, Om(s) + l), 1, ...e),
                        (l += e.length - 1),
                        n)
                    ) {
                        let t = 0;
                        for (let n = 0; n < e.length; n++)
                            t += i(e[n], o, Om(s) + n + t, c);
                    }
                    u = !0;
                },
                skip() {
...
var km = String.raw`\(\?(?:[:=!>A-Za-z\-]|<[=!]|\(DEFINE\))`;
function Am(e, t) {
...
var Mm = Object.freeze({ DEFAULT: `DEFAULT`, CHAR_CLASS: `CHAR_CLASS` });
function Nm(e, t, n, r) {
    ...
    for (let t of e.matchAll(i)) {
        ...
        if (!i && (!r || (r === Mm.DEFAULT) == !o)) {
            n instanceof Function
                ? (s += n(t, {
                      context: o ? Mm.CHAR_CLASS : Mm.DEFAULT,
...
function Fm(e, t, n = 0, r) {
    ...
    for (; (o = i.exec(e));) {
        ...
        if (!t && (!r || (r === Mm.DEFAULT) == !a)) return o;
        (e === `[` ? a++ : e === `]` && a && a--,
...
var Rm = new RegExp(
    String.raw`(?<noncapturingStart>${km})|(?<capturingStart>\((?:\?<[^>]+>)?)|\\?.`,
    `gsu`,
);
function zm(e, t) {
    ...
    do {
        ...
        let t = 0,
            ...
            d = !1,
            f;
        for (Rm.lastIndex = Number.isNaN(c) ? 0 : c + 7; (f = Rm.exec(e));) {
            let {
                0: p,
                index: m,
        ...
        (e = Nm(
            ...
            ({ 0: e, groups: { backrefNum: t, wrappedBackrefNum: n } }) => {
                if (t) {
                    ...
                    if (n > i.length - 1)
                        throw Error(
                            `Backref "${e}" greater than number of captures`,
                        );
                    return `\\${i[n]}`;
                }
                return `\\${n}`;
...
| (?<qBase>${Bm})(?<qMod>[?+]?)(?<invalidQ>[?*+\{]?)
| \\?.
`.replace(/\s+/g, ``),
        `gsu`,
    );
function Hm(e) {
    if (!RegExp(`${Bm}\\+`).test(e)) return { pattern: e };
    let t = [],
        n = null,
        r = null,
        i = ``,
        a = 0,
        o;
    for (Vm.lastIndex = 0; (o = Vm.exec(e));) {
        let {
            0: s,
            index: c,
        ...
        if (s === `[`) (a || (r = c), a++);
            ...
            if (u === `+` && i && !i.startsWith(`(`)) {
                ...
                let t = -1;
                if (/^\{\d+\}$/.test(l)) e = jm(e, c + l.length, u, ``);
                else {
                    if (i === `)` || i === `]`) {
                        let t = i === `)` ? n : r;
                ...
                s[0] === `(`
                    ? t.push(c)
                    : s === `)` && (n = t.length ? t.pop() : null);
        i = s;
    }
    return { pattern: e };
}
var Um = String.raw,
    Wm = Um`\(\?R=(?<rDepth>[^\)]+)\)|${Um`\\g<(?<gRNameOrNum>[^>&]+)&R=(?<gRDepth>[^>]+)>`}`,
    Gm = Um`\(\?<(?![=!])(?<captureName>[^>]+)>`,
    Km = Um`${Gm}|(?<unnamed>\()(?!\?)`,
    qm = new RegExp(Um`${Gm}|${Wm}|\(\?|\\?.`, `gsu`),
    Jm = `Cannot use multiple overlapping recursions`;
function Ym(e, t) {
    ...
    let a = [],
        ...
        d = 0,
        f;
    for (qm.lastIndex = 0; (f = qm.exec(e));) {
        let {
            0: t,
        ...
        if (t === `[`) u++;
            ...
            if ((Xm(m), l)) throw Error(Jm);
            if (o)
                throw Error(
                    `${r === `external` ? `Backrefs` : `Numbered backrefs`} cannot be used with global recursion`,
                );
            let t = e.slice(0, f.index),
                s = e.slice(qm.lastIndex);
            if (Im(s, Wm, Mm.DEFAULT)) throw Error(Jm);
            let c = m - 1;
            ((e = Zm(t, s, c, !1, n, a, d)), (i = eh(i, t, c, a.length, 0, d)));
            break;
        } else if (h) {
            Xm(g);
            let u = !1;
            for (let e of c)
                if (e.name === h || e.num === +h) {
                    if (((u = !0), e.hasRecursedWithin)) throw Error(Jm);
                    break;
                }
            if (!u)
                throw Error(
                    Um`Recursive \g cannot be used outside the referenced group "${r === `external` ? h : Um`\g<${h}&R=${g}>`}"`,
                );
            let p = s.get(h),
                m = Lm(e, p);
            if (o && Im(m, Um`${Gm}|\((?!\?)`, Mm.DEFAULT))
                throw Error(
            ...
            let _ = e.slice(p, f.index),
                ...
                b = g - 1,
                x = Zm(_, v, b, !0, n, a, d);
            ((i = eh(i, _, b, a.length - y, y, d)),
                (e = `${e.slice(0, p)}${x}${e.slice(p + m.length)}`),
                (qm.lastIndex += x.length - t.length - _.length - v.length),
                c.forEach((e) => (e.hasRecursedWithin = !0)),
                (l = !0));
        } else if (p)
            (d++,
                s.set(String(d), qm.lastIndex),
                s.set(p, qm.lastIndex),
                c.push({ num: d, name: p }));
        else if (t[0] === `(`) {
            let e = t === `(`;
            (e && (d++, s.set(String(d), qm.lastIndex)),
                c.push(e ? { num: d } : {}));
        } else t === `)` && c.pop();
    }
    return (
        n.push(...a), { pattern: e, captureTransfers: i, hiddenCaptures: n }
    );
}
function Xm(e) {
...
function Zm(e, t, n, r, i, a, o) {
    ...
    return `${e}${Qm(`(?:${e}`, `forward`, ...c)}(?:)${Qm(`${t})`, `backward`, ...c)}${t}`;
}
            ...
            e.forEach((e, t) => {
                ...
                for (let t of e)
                    if (t <= s) u.push(t);
                        ...
                        for (let e = 0; e <= n; e++) u.push(t + o * e);
...
var Z = String.fromCodePoint,
    Q = String.raw,
    th = { flagGroups: !0, unicodeSets: !0 };
((th.bugFlagVLiteralHyphenIsRange = th.unicodeSets
    ? (() => {
          try {
              new RegExp(Q`[\d\-a]`, `v`);
          } catch {
    ...
    : !1),
    (th.bugNestedClassIgnoresNegation =
        th.unicodeSets && RegExp(`[[^a]]`, `v`).test(`a`)));
function nh(e, { enable: t, disable: n }) {
    return {
...
var oh = { ES2025: 2025, ES2024: 2024, ES2018: 2018 },
    sh = { auto: `auto`, ES2025: `ES2025`, ES2024: `ES2024`, ES2018: `ES2018` };
function ch(e = {}) {
    if ({}.toString.call(e) !== `[object Object]`)
        throw Error(`Unexpected options`);
    if (e.target !== void 0 && !sh[e.target])
...
var lh = `[	-\r ]`,
    uh = new Set([Z(304), Z(305)]),
    dh = Q`[\p{L}\p{M}\p{N}\p{Pc}]`;
function fh(e) {
    if (uh.has(e)) return [e];
    let t = new Set(),
        n = e.toLowerCase(),
        r = n.toUpperCase(),
        i = gh.get(n),
...
function Sh(e, t) {
    ...
    let r = {
        ...
        minTargetEs2024: ih(n.bestEffortTarget, `ES2024`),
        passedLookbehind: !1,
        strategy: null,
...
var Ch = {
        AbsenceFunction({ node: e, parent: t, replaceWith: n }) {
            ...
            if (i === `repeater`) {
                let e = cm();
                e.body[0].body.push(lm({ negate: !0, body: r }), hm(`Any`));
                let i = cm();
                (i.body[0].body.push(fm(`greedy`, 0, 1 / 0, e)),
                    n($(i, t), { traverse: !0 }));
        ...
        Assertion(
            ...
            if (c === `text_segment_boundary`)
                throw Error(
                    `Unsupported text segment boundary "\\${l ? `Y` : `y`}"`,
                );
            if (c === `line_end`)
                o(
                    $(
                ...
                if (f.has(e)) ((i.flags.sticky = !0), a());
                    ...
                    let e = r[n - 1];
                    if (e && zh(e)) o($(lm({ negate: !0 }), t));
                    else if (d)
                        throw Error(
                            Q`Uses "\G" in a way that requires a subclass`,
                        );
                    else
                        (o(Wh($p(`string_start`), t)),
                            (s.strategy = `clip_search`));
                }
            else if (!(c === `string_end` || c === `string_start`))
                if (c === `string_end_newline`) o($(Hh(Q`(?=\n?\z)`), t));
        ...
        Backreference({ node: e }, { jsGroupNameMap: t }) {
            let { ref: n } = e;
            typeof n == `string` && !Vh(n) && ((n = Mh(n, t)), (e.ref = n));
        },
        CapturingGroup(
            { node: e },
            { jsGroupNameMap: t, subroutineRefMap: n },
        ) {
            let { name: r } = e;
            (r && !Vh(r) && ((r = Mh(r, t)), (e.name = r)),
                n.set(e.number, e),
                r && n.set(r, e));
        },
        CharacterClassRange({ node: e, parent: t, replaceWith: n }) {
            t.kind === `intersection` &&
                n($(rm({ body: [e] }), t), { traverse: !0 });
        },
        CharacterSet(
            ...
            if (s && (c === `word` || u === `word`)) {
                n(Wh(am(`word`, { negate: l }), t));
                return;
            }
            if (c === `any`) n(Wh(hm(`Any`), t));
            else if (c === `digit`) n(Wh(hm(`Nd`, { negate: l }), t));
            else if (c !== `dot`)
                if (c === `text_segment`) {
                    if (r === `strict`)
                        throw Error(
                            Q`Use of "\X" requires non-strict accuracy`,
                        );
                    ...
                    n(
                        $(
                            Hh(
                                Q`(?>\r\n|${i ? Q`\p{RGI_Emoji}` : a}|\P{M}\p{M}*)`,
                                { skipPropertyNameValidation: !0 },
                            ),
                            t,
                        ),
                    );
                } else if (c === `hex`) n(Wh(hm(`AHex`, { negate: l }), t));
                else if (c === `newline`)
                    n(
                        $(
                            Hh(
...
\v\f\u2028\u2029])`,
                    ...
                    if (!i && (u === `graph` || u === `print`)) {
                        ...
                        (l &&
                            ...
                            n($(Hh(`[${e}]`), t)));
                    } else n($(Uh(Hh(_h.get(u)), l), t));
                else if (c === `property`) ph.has(Cm(u)) || (e.key = `sc`);
                else if (c === `space`) n(Wh(hm(`space`, { negate: l }), t));
                else if (c === `word`) n($(Uh(Hh(dh), l), t));
        ...
        Directive({
            ...
            if (s === `flags`)
                ...
                if (t.parent !== r || r.body.length > 1)
                    throw Error(Q`Uses "\K" in a way that's unsupported`);
                let o = lm({ behind: !0 });
        ...
        Flags({ node: e, parent: t }) {
            ...
            if (e.textSegmentMode === `word`)
                throw Error(`Unsupported flag "y{w}"`);
            ([
                `digitIsAscii`,
                `extended`,
                `posixIsAscii`,
        ...
        NamedCallout({ node: e, parent: t, replaceWith: n }) {
            let { kind: r } = e;
            if (r === `fail`) n($(lm({ negate: !0 }), t));
            else
                throw Error(`Unsupported named callout "(*${r.toUpperCase()}"`);
        },
        Quantifier({ node: e }) {
        ...
        Regex: {
            ...
            exit(e, { accuracy: t, passedLookbehind: n, strategy: r }) {
                if (t === `strict` && n && r)
                    throw Error(
                        Q`Uses "\G" in a way that requires non-strict accuracy`,
                    );
            },
        },
    ...
    wh = {
        ...
        Group: {
            enter({ node: e }, t) {
                ((t.prevFlags = t.currentFlags),
                    e.flags && (t.currentFlags = nh(t.currentFlags, e.flags)));
            },
            exit(e, t) {
        ...
        Subroutine({ node: e, parent: t, replaceWith: n }, r) {
            ...
            let o = r.subroutineRefMap.get(a),
                s = a === 0,
                c = s ? Ah(0) : kh(o, r.groupOriginByCopy, null),
                l = c;
            if (!s) {
                let e = Nh(jh(o, (e) => e.type === `Group` && !!e.flags)),
                    t = e ? nh(r.globalFlags, e) : r.globalFlags;
                Dh(t, r.currentFlags) ||
                    ((l = cm({ flags: Ph(t) })), l.body[0].body.push(c));
            }
            n($(l, t), { traverse: !s });
        },
    },
    Th = {
        Backreference({ node: e, parent: t, replaceWith: n }, r) {
            if (e.orphan) {
                r.highestOrphanBackref = Math.max(
                    r.highestOrphanBackref,
                    e.ref,
                );
                return;
            }
            let i = r.reffedNodesByReferencer.get(e).filter((t) => Oh(t, e));
            i.length
                ? i.length > 1
                    ? n(
                          $(
        ...
        CapturingGroup({ node: e }, t) {
            ((e.number = ++t.numCapturesToLeft),
                e.name &&
                    t.groupsByName.get(e.name).get(e)
        ...
        Regex: {
            exit({ node: e }, t) {
                let n = Math.max(
                    t.highestOrphanBackref - t.numCapturesToLeft,
                    0,
                );
                for (let t = 0; t < n; t++) {
                    let t = tm();
...
function Ph({ dotAll: e, ignoreCase: t }) {
    let n = {};
    return (
        (e || t) &&
            ((n.enable = {}),
...
function Ih(e) {
    let t = e.find(
        (e) => e.kind === `search_start` || Bh(e, { negate: !1 }) || !Rh(e),
    );
    if (!t) return null;
...
function Lh(e, t) {
    let n = Fh(e) ?? [];
    for (let e of n) if (e === t || Lh(e, t)) return !0;
    return !1;
}
function Rh({ type: e }) {
    return (
        e === `Assertion` || e === `Directive` || e === `LookaroundAssertion`
    );
}
function zh(e) {
...
function Bh(e, t) {
    ...
    return (
        ...
        e.body.length === 1 &&
        zp(e.body[0], { type: `Assertion`, kind: `search_start` })
    );
}
function Vh(e) {
...
function Hh(e, t) {
    let n = Hp(e, { ...t, unicodePropertyMap: ph }).body;
    return n.length > 1 || n[0].body.length > 1
        ? cm({ body: n })
        : n[0].body[0];
}
function Uh(e, t) {
...
function $(e, t) {
    return (Eh(e), (e.parent = t), e);
}
function Gh(e, t) {
    let n = ch(t),
        r = ih(n.target, `ES2024`),
        i = ih(n.target, `ES2025`),
    ...
    function d(e) {
        return (
            (u.lastNode = l),
            (l = e),
            ah(qh[e.type], `Unexpected node type "${e.type}"`)(e, u, d)
        );
    }
    let f = {
    ...
    return (
        ...
        u.captureMap.forEach((e, t) => {
            (e.hidden && f._hiddenCaptures.push(t),
                e.transferTo &&
                    rh(f._captureTransfers, e.transferTo, []).push(t));
        }),
        f
    );
}
var Kh = {
        '*': {
            enter({ node: e }, t) {
                if (ag(e)) {
                    ...
                    t.pushModI(
                        e.flags ? nh({ ignoreCase: n }, e.flags).ignoreCase : n,
                    );
                }
            },
            exit({ node: e }, t) {
        ...
        Character({ node: e }, t) {
            $h(Z(e.value)) && t.setHasCasedChar();
        },
        CharacterClassRange({ node: e, skip: t }, n) {
            (t(), eg(e, { firstOnly: !0 }).length && n.setHasCasedChar());
        },
        CharacterSet({ node: e }, t) {
            e.kind === `property` && xh.has(e.value) && t.setHasCasedChar();
        },
    },
    qh = {
        ...
        CapturingGroup(e, t, n) {
            ...
            return (
                s &&
                    ((o.hidden = !0),
                    a > s.number && (o.transferTo = s.number)),
        ...
        Character({ value: e }, t) {
            ...
            if (r !== n) return r;
            if (t.useAppliedIgnoreCase && t.currentFlags.ignoreCase && $h(n)) {
                let e = fh(n);
        ...
        CharacterClass(e, t, n) {
            ...
            th.bugFlagVLiteralHyphenIsRange &&
                t.useFlagV &&
                o.some(sg) &&
                (o = [nm(45), ...o.filter((e) => !sg(e))]);
            let s = () =>
                `[${i ? `^` : ``}${o.map(n).join(r === `intersection` ? `&&` : ``)}]`;
            if (!t.inCharClass) {
                if ((!t.useFlagV || th.bugNestedClassIgnoresNegation) && !i) {
                    let t = o.filter(
                        (e) =>
            ...
            if (
                ...
                (((!t.useFlagV || !t.verbose) &&
                    a.kind === `union` &&
                    !(th.bugFlagVLiteralHyphenIsRange && t.useFlagV)) ||
                    (!t.verbose &&
                        a.kind === `intersection` &&
                        o.length === 1 &&
        ...
        CharacterSet({ kind: e, negate: t, value: n, key: r }, i) {
            ...
            if (e === `property`) {
                if (
                    i.useAppliedIgnoreCase &&
                    i.currentFlags.ignoreCase &&
                    xh.has(n)
                )
                    throw Error(
        ...
        Quantifier(e, t, n) {
            return n(e.body) + ig(e);
        },
        Subroutine({ isRecursive: e, ref: t }, n) {
            if (!e)
                throw Error(
                    `Unexpected non-recursive subroutine in transformed AST`,
                );
...
function tg(e, { escDigit: t, inCharClass: n, useFlagV: r }) {
    if (Zh.has(e)) return Zh.get(e);
    if (e < 32 || (e > 126 && e < 160) || e > 262143 || (t && og(e)))
        return e > 255
...
function ig({ kind: e, max: t, min: n }) {
    let r;
    return (
        (r =
            !n && t === 1
...
function ag({ type: e }) {
    return (
        e === `CapturingGroup` || e === `Group` || e === `LookaroundAssertion`
    );
}
function og(e) {
    return e > 47 && e < 58;
}
function sg({ type: e, value: t }) {
    return e === `Character` && t === 45;
}
var cg = class e extends RegExp {
    #e = new Map();
    #t = null;
    #n;
    #r = null;
    ...
    constructor(t, n, r) {
        ...
        if (t instanceof RegExp) {
            ...
            (super(i ? `` : t, n),
                (this.#n = t),
                (this.#e = ug(e.hiddenCaptures, e.transfers)),
                (this.#i = e.strategy),
                (this.rawOptions = r ?? {}));
        }
        i || (this.#t = this);
    ...
    exec(t) {
        ...
        if (this.#i === `clip_search` && n && r) {
            ...
            return (
                e && (lg(e, r, t, this.hasIndices), (this.lastIndex += r)), e
            );
        }
        return this.#a(t);
    }
    #a(e) {
        ...
        if (((this.lastIndex = this.#t.lastIndex), !t || !this.#e.size))
            return t;
        let n = [...t];
        t.length = 1;
        let r;
        ...
        for (let e = 1; e < n.length; e++) {
            ...
            if (
                ...
                if (
                    ((t[a] = n[e]),
                    this.hasIndices && (t.indices[a] = r[e]),
                    t.groups)
                ) {
                    this.#r ||= dg(this.source);
                    let i = this.#r.get(o);
                    i &&
                        ((t.groups[i] = n[e]),
...
function ug(e, t) {
    ...
    for (let [e, r] of t) for (let t of r) rh(n, t, {}).transferTo = e;
    return n;
}
function dg(e) {
...
function fg(e, t) {
    let n = pg(e, t);
    return n.options
        ? new cg(n.pattern, n.flags, n.options)
...
function _g(e = {}) {
    ...
    return (
        (t.regexConstructor ||= (e) => gg(e, { target: t.target })),
        {
            createScanner(e) {
                return new hg(e, t);
            },
...
(Ks(`[data-tippy-content]`, { ...jg, allowHTML: !1 }),
    Ks(`[data-tippy-html-content]`, { ...jg, allowHTML: !0 }),
    (window.copyToClipboard = async function (e) {
        if (navigator.clipboard) await navigator.clipboard.writeText(e);
            ...
            if ((document.body.removeChild(t), !n))
                throw Error(`Failed to copy text to clipboard`);
        }
    }));
var Mg = Yf({ themes: [Ag, kg], langs: [Og, Eg, vg], engine: _g() });
((window.highlight = function (e, t, n = !1, r = !1, i = 1, a = null) {
    return Mg.codeToHtml(e, {
        lang: t,
        themes: { light: `light-plus`, dark: `dark-plus` },
        transformers: [
            {
                pre(e) {
                    this.addClassToHast(e, [
                        `bg-transparent!`,
                        n ? `truncate` : `w-fit min-w-full`,
                    ]);
                },
                line(e, t) {
                    if (!r) return;
