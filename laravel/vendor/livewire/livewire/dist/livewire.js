...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
    ...
    var BaseReactiveHandler = class {
        ...
        get(target, key, receiver) {
            ...
            if (isRef(res)) {
                ...
                return isReadonly2 && isObject2(value)
                    ? readonly(value)
                    : value;
            }
            if (isObject2(res)) {
    ...
    var toReactive = (value) =>
        isObject2(value) ? /* @__PURE__ */ reactive2(value) : value;
    var toReadonly = (value) =>
        isObject2(value) ? /* @__PURE__ */ readonly(value) : value;
    function isRef(r) {
    ...
    directive(
        ...
        (el, { modifiers, expression }, { effect: effect3, cleanup }) => {
            ...
            if (isCloning) {
                ...
                removeListener = () =>
                    listeners2.forEach((remove2) => remove2());
            } else {
                let event =
    ...
    directive(
        'for',
        skipDuringClone((el, { expression }, { effect: effect3, cleanup }) => {
    ...
    var Message = class {
        ...
        invokeOnSuccess() {
            this.interceptors.forEach((interceptor2) => {
                interceptor2.onSuccess({
                    ...
                    onMorphed: (callback) =>
                        (interceptor2.onMorphed = callback),
        ...
        invokeOnMorphed() {
            this.interceptors.forEach((interceptor2) =>
                interceptor2.onMorphed(),
            );
        }
        invokeOnRender() {
            this.interceptors.forEach((interceptor2) =>
                interceptor2.onRender(),
            );
        }
        invokeOnFinish() {
            this.interceptors.forEach((interceptor2) =>
    ...
    function interceptComponentMessage(
        ...
        let actionName =
            typeof actionNameOrCallback === 'string'
                ...
                : null;
        let callback = actionName ? maybeCallback : actionNameOrCallback;
        return interceptors2.addInterceptor(
            component,
            ({ message, ...rest }) => {
                if (actionName) {
    ...
    function directive2(name, callback) {
        ...
        on2(
            'directive.init',
            ({ el, component, directive: directive3, cleanup }) => {
    ...
    function globalDirective(name, callback) {
        ...
        on2(
            ...
            ({ el, directive: directive3, cleanup }) => {
                if (directive3.value === name) {
    ...
    function deferInit2(el, promise) {
        if (module_default.deferInit) module_default.deferInit(el, promise);
    }
...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
        ...
        Alpine3.directive(
            ...
            Alpine3.skipDuringClone(
                (
                    ...
                    { evaluateLater: evaluateLater2, cleanup },
                ) => {
    ...
    function src_default6(Alpine3) {
        Alpine3.directive(
            ...
            (
                ...
                { effect: effect3, evaluate: evaluate3, cleanup },
            ) => {
                if (value === 'config') {
                    return;
                }
        ...
        Alpine3.directive(
            ...
            Alpine3.skipDuringClone(
                (
                    ...
                    { evaluate: evaluate22, effect: effect3, cleanup },
                ) => {
                    let {
                        placement,
                        offsetValue,
                    ...
                    effect3(() => {
                        ...
                        if (previousReference !== reference) {
                            ...
                            release2 = autoUpdate(reference, el, () =>
                                compute(),
                            );
                        }
                    });
        ...
        writeToHistory(method, url, callback) {
            ...
            try {
                ...
                Object.values(this.errorHandlers).forEach(
                    (handler4) =>
                        typeof handler4 === 'function' && handler4(error2, url),
                );
                this.errorHandlers = {};
                console.error(error2);
            }
    ...
    function track2(name, initialSeedValue, alwaysShow = false, except = null) {
        ...
        if (alwaysShow) url = set2(url, name, initialValue);
    ...
    on2('directive.init', ({ el, directive: directive3 }) => {
        if (!directive3.rawName.startsWith('wire:sort:item')) return;
    ...
    on2(
        'directive.init',
        ({ el, directive: directive3, cleanup, component }) => {
            if (
                [
                    'snapshot',
                    'effects',
        ...
        ({ el, directive: directive3, component, cleanup }) => {
            ...
            let startLoading = () => {
                if (activeLoadingCount === 0) {
                    if (directive3.modifiers.includes('class')) {
                        let classes = directive3.expression
                            .split(' ')
                            .filter(String);
    ...
    directive2('init', ({ component, el, directive: directive3 }) => {
        let fullMethod = directive3.expression
