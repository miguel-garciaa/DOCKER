    ...
    var require_module_cjs = __commonJS({
        'node_modules/@alpinejs/csp/dist/module.cjs.js'(exports, module) {
            ...
            var __toCommonJS = (mod) =>
                __copyProps2(
                    __defProp2({}, '__esModule', { value: true }),
                    mod,
                );
            var require_shared_cjs = __commonJS2({
                'node_modules/@vue/shared/dist/shared.cjs.js'(exports2) {
                    ...
                    var isPromise = (val) => {
                        return (
                            (isObject22(val) || isFunction2(val)) &&
                    ...
                    exports2.cssVarNameEscapeSymbolsRE =
                ...
                'node_modules/@vue/reactivity/dist/reactivity.cjs.js'(
                    ...
                    function refreshComputed(computed2) {
                        ...
                        if (
                            !computed2.isSSR &&
                            computed2.flags & 128 &&
                            ((!computed2.deps && !computed2._dirty) ||
                                !isDirty(computed2))
                        ) {
                            return;
                        }
                        ...
                        try {
                            ...
                            if (
                                dep.version === 0 ||
                                shared.hasChanged(value, computed2._value)
                            ) {
                                computed2.flags |= 128;
                    ...
                    var MAP_KEY_ITERATE_KEY =
                        /* @__PURE__ */ Symbol('Map keys iterate');
                    var ARRAY_ITERATE_KEY =
                        /* @__PURE__ */ Symbol('Array iterate');
                    ...
                    var arrayInstrumentations = {
                        __proto__: null,
                        [Symbol.iterator]() {
                            return iterator(this, Symbol.iterator, (item) =>
                                toWrapped(this, item),
                            );
                        },
                        concat(...args) {
                        ...
                        values() {
                            return iterator(this, 'values', (item) =>
                                toWrapped(this, item),
                            );
                        },
                    };
                    ...
                    function reduce(self2, method, fn, args) {
                        ...
                        return wrapInitialAccumulator
                            ? toWrapped(self2, result)
                            : result;
                    }
                            ...
                            if (isRef(res)) {
                                const value =
                                    targetIsArray && shared.isIntegerKey(key)
                                        ? res
                                        : res.value;
                                return isReadonly2 && shared.isObject(value)
                                    ? readonly(value)
                                    : value;
                            }
                    ...
                    var MutableReactiveHandler = class extends BaseReactiveHandler {
                        ...
                        set(target, key, value, receiver) {
                            ...
                            const isArrayWithIntegerKey =
                                shared.isArray(target) &&
                                shared.isIntegerKey(key);
                            if (!this._isShallow) {
                    ...
                    function createIterableMethod(
                        ...
                        return function (...args) {
                            ...
                            return shared.extend(Object.create(innerIterator), {
                                next() {
                                    const { value, done } =
                                        innerIterator.next();
                                    return done
                                ...
                                : {
                                      ...
                                      set(key, value) {
                                          ...
                                          if (!hadKey) {
                                              ...
                                              shared.hasChanged(value, oldValue)
                                          ) {
                                              trigger2(
                                                  target,
                                                  'set',
                    ...
                    var toReactive = (value) =>
                        shared.isObject(value)
                            ? /* @__PURE__ */ reactive3(value)
                            : value;
                    var toReadonly = (value) =>
                        shared.isObject(value)
                            ? /* @__PURE__ */ readonly(value)
                            : value;
                    function isRef(r) {
                    ...
                    function toValue(source) {
                        return shared.isFunction(source)
                            ? source()
                            : unref(source);
                    }
                    ...
                    var ObjectRefImpl = class {
                        constructor(_object, key, _defaultValue) {
                            ...
                            let obj = _object;
                            if (
                                !shared.isArray(_object) ||
                                shared.isSymbol(this._key) ||
                                !shared.isIntegerKey(this._key)
                            ) {
                                do {
                        ...
                        set value(newVal) {
                            if (
                                this._shallow &&
                                /* @__PURE__ */ isRef(this._raw[this._key])
                            ) {
                    ...
                    function watch2(source, cb, options = shared.EMPTY_OBJ) {
                        ...
                        const job = (immediateFirstRun) => {
                            if (
                                !(effect4.flags & 1) ||
                                (!effect4.dirty && !immediateFirstRun)
                            ) {
                                return;
                            }
                            if (cb) {
                                ...
                                if (
                                    ...
                                    (isMultiSource
                                        ? newValue.some((v, i) =>
                                              shared.hasChanged(v, oldValue[i]),
                                          )
                        ...
                        effect4.scheduler = scheduler2
                            ? () => scheduler2(job, false)
                            : job;
                        boundCleanup = (fn) =>
                            onWatcherCleanup(fn, false, effect4);
            ...
            function sortPendingJobs(start22) {
                ...
                let sorted = queue
                    .slice(start22)
                    .sort((a, b) => compareJobs(a, b, depths));
            ...
            function compareJobs(a, b, depths) {
                ...
                let depthDifference =
                    getElementDepth(a._x_schedulerPriority.el, depths) -
                    getElementDepth(b._x_schedulerPriority.el, depths);
                return (
                    depthDifference ||
                    a._x_schedulerPriority.order - b._x_schedulerPriority.order
                );
            }
            ...
            function flushObserver() {
                ...
                queuedMutations.push(
                    () => records.length > 0 && onMutate(records),
                );
...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
            ...
            function getDirectiveHandler(el, directive22) {
                ...
                let fullHandler = () => {
                    ...
                    handler4.inline &&
                        handler4.inline(el, directive22, utilities);
                    handler4 = handler4.bind(
                        handler4,
                        el,
                        directive22,
                        utilities,
            ...
            function replayQueuedAttributes(record) {
                record.queuedAttributes.forEach((entry, el) => {
                    ...
                    let suspendedAncestor = findClosest(
                        el,
                        (i) => i._x_deferInit,
                    );
                    if (suspendedAncestor) {
                        queueInto(
                            suspendedAncestor._x_deferInit,
                            el,
                            Array.from(entry.names),
                        );
                        return;
                    }
            ...
            function warnAboutMissingPlugins() {
                ...
                pluginDirectives.forEach(
                    ([plugin2, directive22, selectors]) => {
            ...
            function registerTransitionsFromHelper(el, modifiers, stage) {
                ...
                let scaleValue = wantsScale
                    ? modifierValue2(modifiers, 'scale', 95) / 100
                    : 1;
                let delay3 = modifierValue2(modifiers, 'delay', 0) / 1e3;
                let origin = modifierValue2(modifiers, 'origin', 'center');
                let property = 'opacity, transform';
                let durationIn =
                    modifierValue2(modifiers, 'duration', 150) / 1e3;
                let durationOut =
                    modifierValue2(modifiers, 'duration', 75) / 1e3;
            ...
            function extractProp(el, name, fallback2, extract = true) {
                ...
                if (
                    ...
                    el._x_inlineBindings[name] !== void 0
                ) {
            ...
            var Tokenizer = class {
                ...
                tokenize() {
                    ...
                    this.tokens.push(
                        new Token('EOF', null, this.position, this.position),
                    );
                    return this.tokens;
                }
                skipWhitespace() {
                ...
                readIdentifierOrKeyword() {
                    ...
                    if (keywords.includes(value)) {
                        if (value === 'true' || value === 'false') {
                            ...
                            this.tokens.push(
                                new Token('NULL', null, start22, this.position),
                            );
                ...
                readString() {
                        ...
                        if (escaped) {
                            switch (char) {
                                ...
                                case quote:
                                    ...
                                    break;
                                case 'u': {
                                    const codeUnit = this.input.slice(
                                        this.position + 1,
                                        this.position + 5,
                                    );
                                    if (/^[0-9a-fA-F]{4}$/.test(codeUnit)) {
                                        value += String.fromCharCode(
                                            parseInt(codeUnit, 16),
                                        );
                                        this.position += 4;
                                    } else {
                                        value += char;
                    ...
                    throw new Error(
                        `Unterminated string starting at position ${start22}`,
                    );
                }
                readOperatorOrPunctuation() {
                    ...
                    if (char === '=' && next === '=' && nextNext === '=') {
                        ...
                        this.position += 2;
                        this.tokens.push(
                            new Token('OPERATOR', '==', start22, this.position),
                        );
                    } else if (char === '!' && next === '=') {
                        this.position += 2;
                        this.tokens.push(
                        ...
                        const type = '()[]{},.;:?'.includes(char)
                            ...
                            : 'OPERATOR';
                        this.tokens.push(
                            new Token(type, char, start22, this.position),
                        );
                    }
                }
            };
            ...
            var Evaluator = class {
                        ...
                        case 'UpdateExpression':
                            if (node.argument.type === 'Identifier') {
                                ...
                                if (this.isDOMObject(obj)) {
                                    throw new Error(
                                        'Property assignments on DOM objects are prohibited in the CSP build',
                                    );
                                }
                                this.checkForDangerousKeywords(prop);
                ...
                isDOMObject(obj) {
                    return (
                        ...
                        (typeof DOMStringMap !== 'undefined' &&
                            obj instanceof DOMStringMap) ||
                        (typeof DOMTokenList !== 'undefined' &&
                            obj instanceof DOMTokenList) ||
                        (typeof NamedNodeMap !== 'undefined' &&
                ...
                checkForDangerousKeywords(keyword) {
                    ...
                    if (blacklist.includes(keyword)) {
                        throw new Error(
                            `Accessing "${keyword}" is prohibited in the CSP build`,
                        );
                    }
                }
                checkForDangerousValues(prop) {
                    ...
                    if (
                        prop instanceof HTMLIFrameElement ||
                        prop instanceof HTMLScriptElement
                    ) {
                        throw new Error(
                            'Accessing iframes and scripts is prohibited in the CSP build',
                        );
                    }
                    if (globals.has(prop)) {
                        throw new Error(
                            'Accessing global variables is prohibited in the CSP build',
                        );
                    }
            ...
            function cspRawEvaluator(el, expression, extras = {}) {
                ...
                let scope2 = mergeProxies([
                    (_a = extras.scope) != null ? _a : {},
                    ...dataStack,
                ]);
            ...
            function generateEvaluator(el, expression, dataStack) {
                if (el instanceof HTMLIFrameElement) {
                    throw new Error(
                        'Evaluating expressions on an iframe is prohibited in the CSP build',
                    );
                }
                if (el instanceof HTMLScriptElement) {
                    throw new Error(
                        'Evaluating expressions on a script is prohibited in the CSP build',
                    );
                }
                return (
                    receiver = () => {},
                    ...
                    if (
                        ...
                        let nextReturnValue = returnValue.apply(
                            returnValue,
                            params,
                        );
            ...
            function on4(el, event, modifiers, callback) {
                ...
                if (modifiers.includes('passive')) {
                    options.passive =
                        modifiers[modifiers.indexOf('passive') + 1] !== 'false';
                }
                ...
                if (event === 'submit') {
                    handler4 = wrapHandler(handler4, (next, e) => {
                        if (e.target._x_pendingModelUpdates) {
                            e.target._x_pendingModelUpdates.forEach((fn) =>
                                fn(),
                            );
                        }
                        next(e);
            ...
            directive2(
                ...
                (
                    ...
                    if (isCloning) {
                        ...
                        let syncValue = (e) =>
                            setValue(
                                getInputValue(el, modifiers, e, getValue()),
                            );
                        if (hasChangeModifier) {
                            listeners2.push(
                                on4(el, 'change', modifiers, syncValue),
                            );
                        }
                        if (hasBlurModifier) {
                            listeners2.push(
                                on4(el, 'blur', modifiers, syncValue),
                            );
                            if (el.form) {
                                let form = el.form;
                                let syncCallback = () =>
                                ...
                                cleanup(() => {
                                    if (form._x_pendingModelUpdates) {
                                        form._x_pendingModelUpdates.splice(
                                            form._x_pendingModelUpdates.indexOf(
                                                syncCallback,
                                            ),
                                            1,
                                        );
                        ...
                        if (hasEnterModifier) {
                            listeners2.push(
                                on4(el, 'keydown', modifiers, (e) => {
                                    if (e.key === 'Enter') syncValue(e);
                                }),
                            );
                        }
                        removeListener = () =>
                            listeners2.forEach((remove) => remove());
                    } else {
                        let event =
                    ...
                    el._x_model = {
                        ...
                        setWithModifiers: addDebounceOrThrottle(
                            modifiers,
                            setValue,
                        ),
                    };
                        ...
                        mutateDom(() => {
                            if (isCheckbox(el)) {
                                ...
                                if (typeof value === 'boolean') {
                                    el.checked =
                                        safeParseBoolean(el.value) === value;
                                } else {
            ...
            directive2(
                'init',
                skipDuringClone(
                    (el, { expression }, { evaluate: evaluate22 }) => {
                        if (typeof expression === 'string') {
                            return (
                                !!expression.trim() &&
                                evaluate22(expression, {}, false)
                            );
                        }
            ...
            directive2('data', (el, { expression }, { cleanup }) => {
                ...
                if (
                    (dataToReconcile == null
                        ? void 0
                        : dataToReconcile.expression) === expression
                )
                    return;
                expression = expression === '' ? '{}' : expression;
                let magicContext = {};
                ...
                let data2 = evaluate2(el, expression, {
                ...
                cleanup(() => {
                    reactiveData['destroy'] &&
                        evaluate2(el, reactiveData['destroy']);
                    undo();
            ...
            function reconcileData(target, source) {
                Object.keys(source).forEach((key) => {
                    ...
                    let existingDescriptor = Object.getOwnPropertyDescriptor(
                        target,
                        key,
                    );
                    if (
            ...
            function loop(
                ...
                evaluateItems((items) => {
                    ...
                    let scopeEntries = Object.entries(items).map(
                        ([index2, item]) => {
                    ...
                    mutateDom(() => {
                        ...
                        scopeEntries.forEach(([key, scope2]) => {
                            ...
                            clone22._x_refreshXForScope =
                                refreshScope(reactiveScope);
            ...
            directive2(
                ...
                skipDuringClone(
                    (el, { expression }, { effect: effect3, cleanup }) => {
                        if (el.tagName.toLowerCase() !== 'template')
                            warn(
                                'x-if can only be used on a <template> tag',
                                el,
                            );
                        let evaluate22 = evaluateLater(el, expression);
                        let show = () => {
            ...
            directive2('html', (el, { expression }) => {
                handleError(
                    new Error(
                        'Using the x-html directive is prohibited in the CSP build',
                    ),
                    el,
                );
            });
    ...
    function diffRecursive(left, right, path, diffs, rootLeft, rootRight) {
        ...
        let hasNonNumericKeys = (arr) => {
            return (
                isArray(arr) && Object.keys(arr).some((k) => isNaN(parseInt(k)))
            );
        };
        if (
            typeof left !== typeof right ||
    ...
    function walkUpwards(el, callback) {
        ...
        while (current) {
            ...
            callback(current, {
                stop: (value) =>
                    value === void 0 ? (stop = current) : (stop = value),
            });
    ...
    function coordinateNetworkInteractions(messageBus2) {
        ...
        interceptAction(({ action }) => {
            ...
            let activeMessages =
                messageBus2.activeMessagesMatchingScope(action);
            ...
            if (message) {
                ...
                let bothAreModelLive =
                    action.metadata.type === 'model.live' &&
                    Array.from(message.actions).every(
                        (action2) => action2.metadata.type === 'model.live',
                    );
                if (bothAreModelLive) {
                    let incomingHasBoundChildren = componentHasBoundChildren(
                        action.component,
                    );
                    let outgoingHasBoundChildren = Array.from(
                        message.actions,
                    ).some((activeAction) =>
                        componentHasBoundChildren(activeAction.component),
                    );
                    if (
                        !incomingHasBoundChildren &&
                        !outgoingHasBoundChildren
                    ) {
                        activeMessages
                            .filter((message2) =>
                                Array.from(message2.actions).every(
                                    (action2) =>
                                        action2.metadata.type === 'model.live',
                                ),
                            )
                            .forEach((message2) =>
                                action.supersedes.add(message2),
                            );
                        return;
                    }
                }
    ...
    var MessageRequest = class {
        ...
        initInterceptors(interceptorRegistry) {
            this.interceptors =
                interceptorRegistry.getRequestInterceptors(this);
            ...
            this.messages.forEach((message) => {
                message
                    .getInterceptors()
                    .forEach((interceptor) => interceptor.init());
            });
        }
        cancel() {
        ...
        invokeOnSend({ responsePromise }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onSend({ responsePromise }),
            );
        ...
        invokeOnFailure({ error: error2 }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onFailure({ error: error2 }),
            );
        ...
        invokeOnStream({ response }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onStream({ response }),
            );
        }
        invokeOnParsed({ response, body }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onParsed({ response, body }),
            );
        }
        invokeOnRedirect({ url, preventDefault }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onRedirect({ url, preventDefault }),
            );
        }
        invokeOnDump({ html, preventDefault }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onDump({ html, preventDefault }),
            );
        }
        invokeOnError({ response, body, preventDefault }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onError({ response, body, preventDefault }),
            );
            this.messages.forEach((message) =>
        ...
        invokeOnSuccess({ response, body, json }) {
            this.interceptors.forEach((interceptor) =>
                interceptor.onSuccess({ response, body, json }),
            );
        }
        invokeOnFinish() {
    ...
    var MessageInterceptor = class {
        ...
        constructor(message, callback) {
            ...
            this.callback({
                ...
                cancel: () => {
                    let attachedToMessage = this.message
                        .getInterceptors()
                        .includes(this);
    ...
    var InterceptorRegistry = class {
        ...
        addInterceptor(component, callback) {
            this.messageInterceptorCallbacksByComponent.add(
                component,
                callback,
            );
            return () => {
                this.messageInterceptorCallbacksByComponent.delete(
                    component,
                    callback,
                );
            };
        ...
        getMessageInterceptors(message) {
            let callbacks = [
                ...this.messageInterceptorCallbacksByComponent.get(
                    message.component,
                ),
    ...
    var MessageBus = class {
        ...
        activeMessagesMatchingScope(action) {
            return Array.from(this.activeMessages).filter((message) =>
        ...
        invokeOnSuccess() {
            ...
            if (
                Object.prototype.hasOwnProperty.call(
                    this.responsePayload.effects,
                    'returns',
                ) &&
                this.responsePayload.effects['returns']
            ) {
    ...
    function registerLegacyEventSupport(interceptRequest2, interceptMessage2) {
        ...
        interceptMessage2(
            ({ message, onCancel, onError, onSuccess, onFinish }) => {
                let respondCallbacks = [];
                let succeedCallbacks = [];
                let failCallbacks = [];
                trigger('commit', {
    ...
    function interceptPartition(callback) {
        ...
        return () => {
            partitionInterceptors.splice(
                partitionInterceptors.indexOf(callback),
                1,
            );
        };
    }
    function interceptComponentAction(
        ...
        let actionName =
            typeof actionNameOrCallback === 'string'
                ? actionNameOrCallback
                : null;
    ...
    function interceptComponentMessage(
        ...
        let actionName =
            typeof actionNameOrCallback === 'string'
                ...
                : null;
        let callback = actionName ? maybeCallback : actionNameOrCallback;
        return interceptors.addInterceptor(
            component,
            ({ message, ...rest }) => {
                if (actionName) {
    ...
    function interceptComponentRequest(
        ...
        return interceptRequest(({ request, ...rest }) => {
            let matchingMessages = Array.from(request.messages).filter((m) => {
                ...
                if (actionName) {
                    return Array.from(m.actions).some(
                        (a) => a.name === actionName,
                    );
                }
                return true;
    ...
    function constructAction(component, method, params, metadata) {
        ...
        pendingInterceptors.forEach((callback) =>
            action.addInterceptor(callback),
        );
        return action;
    }
    ...
    function sendMessages() {
                ...
                callback({
                    ...
                    compileRequest: (messages2) => {
                        let existingRequest = Array.from(requests).find(
                            (request2) =>
                                messages2.some((message2) =>
                                    request2.messages.has(message2),
                                ),
                        );
                        if (existingRequest) {
        ...
        for (let message of messages) {
            ...
            requests.forEach((request) => {
                if (!hasFoundRequest) {
                    let hasMessageForSameComponent = Array.from(
                        request.messages,
                    ).some((m) => m.component === message.component);
                            ...
                            await interceptStreamAndReturnFinalResponse(
                                ...
                                async (json) => {
                                    ...
                                    for (let message of request.messages) {
                                        if (
                                            message.component.id === componentId
                                        ) {
                                            await message.invokeOnStream({
                                                json,
                                            });
                                        }
                                    }
                ...
                success: async ({ response, responseBody, responseJson }) => {
                    ...
                    request.messages.forEach((message) => {
                        messageResponsePayloads.forEach((payload) => {
                            ...
                            let { snapshot: snapshotEncoded, effects } =
                                payload;
                            ...
                            if (snapshot.memo.id === message.component.id) {
                                ...
                                Alpine.transaction(async () => {
                                    ...
                                    if (message.isCancelled()) return;
                                    message.component.processEffects(
                                        effects,
                                        request,
                                    );
    ...
    function supersedeOlderMessages(message) {
        message.actions.forEach((action) => {
            action.supersedes.forEach(
                (olderMessage) => (olderMessage.superseded = true),
            );
        });
    }
    ...
    function getErrorsObject(component) {
        let state = (component.__errorsState ??=
            import_alpinejs3.default.reactive({
                clientErrors: null,
            }));
    ...
    function globalDirective(name, callback) {
        ...
        on(
            ...
            ({ el, directive: directive2, cleanup }) => {
                if (directive2.value === name) {
    ...
    var DirectiveManager = class {
        ...
        get(value) {
            return this.directives.find(
                (directive2) => directive2.value === value,
            );
        }
    ...
    var Directive = class {
        ...
        parseMethodCall(methodString) {
            ...
            if (lastParenIndex === -1) {
                throw new Error(
                    `Missing closing parenthesis for method "${method}"`,
                );
            }
    ...
    function toggleBooleanStateDirective(
        ...
        isTruthy = directive2.modifiers.includes('remove')
            ? !isTruthy
            : isTruthy;
        if (directive2.modifiers.includes('class')) {
            ...
            let display =
                [
                    ...
                    'grid',
                    'inline-flex',
                ].filter((i) => directive2.modifiers.includes(i))[0] ||
                'inline-block';
            display =
    ...
    directive('dirty', ({ el, directive: directive2, component }) => {
        ...
        Alpine.effect(() => {
            ...
            isDirty = checkDirty(
                component,
                targets.length === 0 ? void 0 : targets,
            );
        ...
        if (targets === void 0) {
            ...
            for (let i = 0; i < targets.length; i++) {
                ...
                let canonical = JSON.stringify(
                    dataGet(component.canonical, target),
                );
                let reactive = JSON.stringify(
                    dataGet(component.reactive, target),
                );
    ...
    on('effect', ({ component, effects, request }) => {
        ...
        let ready = Promise.all([
            modulePromise,
            morphGateFor(component, request),
        ])
            .then(([module]) => {
            ...
            .catch((error2) => {
                console.error(
                    `Livewire: The script module for the [${component.name}] component failed:`,
                    error2,
                );
            })
            .finally(() => {
    ...
    interceptMessage(
        ({ message, onSuccess, onCancel, onFailure, onError, onFinish }) => {
            onSuccess(({ onSync, onMorphed }) => {
                onSync(() =>
                    processingMessages.set(message.component, message),
                );
    ...
    function treeIsSuspendedFor(component) {
        return (
            !!import_alpinejs4.default.deferInit && assetIsPendingFor(component)
        );
    }
    ...
    function evaluateExpression(el, expression, options = {}) {
        ...
        try {
            let result = import_alpinejs5.default.evaluateRaw(
                el,
                expression,
                options,
            );
    ...
    function evaluateActionExpression(el, expression, options = {}) {
        if (!expression || expression.trim() === '') return;
        let contextualExpression = contextualizeExpression(
            expression,
            el,
            !isEvaluatingReactiveExpression(),
        );
        try {
            let result = import_alpinejs5.default.evaluateRaw(
                el,
...
${expression ? 'Expression: "' + expression + '"\n\n' : ''}`,
    ...
    function contextualizeExpression(expression, el, preferWireAction = false) {
        ...
        result = result.replace(
            /(^|[^.\w$])(\$?[a-zA-Z_]\w*)/g,
            (m, pre, ident, offset2) => {
                let isWireActionTarget =
                    alpineScopeKeys.includes(ident) &&
                    offset2 + pre.length === actionTargetOffset;
                if (
                    (SKIP.includes(ident) && !isWireActionTarget) ||
                    /^___\d+___$/.test(ident)
                )
                    return pre + ident;
    ...
    function getActionTargetOffset(expression) {
        ...
        let significantRemainder = remainder.replace(
            /^(?:(?:\s+)|(?:\/\*[\s\S]*?\*\/)|(?:\/\/[^\n]*(?:\n|$)))*/,
            '',
        );
        if (
            significantRemainder !== '' &&
            !significantRemainder.startsWith('(') &&
            !significantRemainder.startsWith(';')
        )
            return null;
                ...
                if (assetIsPendingFor(component)) {
                    ...
                    return (...params) => {
                        runAfterAssetIsLoadedFor(component, () => {
                            resolver(
                                component.getJsAction(property)(...params),
                            );
                        });
                        return promise;
                    };
    ...
    wireFallback((component) => (property) => (...params) => {
        ...
        if (isEvaluatingReactiveExpression()) {
            console.warn(
                `Livewire: Cannot call server method "${property}" from a reactive binding like wire:text, wire:show, or wire:bind.`,
                component.el,
            );
            return Promise.resolve();
        }
    ...
    var Component = class {
        ...
        getUpdates() {
            let propertiesDiff = diffAndConsolidate(
                this.canonical,
                this.ephemeral,
            );
        ...
        getDeepChildrenWithBindings(callback) {
            this.getDeepChildren((child) => {
                ...
                if (
                    child.hasReactiveProps() ||
                    child.hasWireModelableBindings()
                ) {
                    callback(child);
                }
            });
        ...
        inscribeSnapshotAndEffectsOnElement() {
            ...
            if (
                ...
                this.originalEffects.listeners
            ) {
            ...
            if (
                ...
                this.originalEffects.scriptModule
            ) {
            ...
            while (sibling) {
                ...
                if (isStartFragmentMarker(sibling)) {
                    if (foundEndMarker.length > 0) {
                        ...
                        let metadata =
                            extractFragmentMetadataFromMarkerNode(sibling);
                        if (isMatch(metadata)) {
    ...
    function isEndFragmentMarker(el) {
        return (
            el.nodeType === 8 && el.textContent.startsWith('[if ENDFRAGMENT')
        );
    }
    ...
    var Fragment = class {
        constructor(startMarkerNode) {
            ...
            this.metadata =
                extractFragmentMetadataFromMarkerNode(startMarkerNode);
        }
        get endMarkerNode() {
            return findMatchingEndMarkerNode(
                this.startMarkerNode,
                this.metadata,
            );
        }
    ...
    function findMatchingEndMarkerNode(startMarkerNode, metadata) {
        ...
        while (current) {
            if (isEndFragmentMarker(current)) {
                let currentMetadata =
                    extractFragmentMetadataFromMarkerNode(current);
                if (
    ...
    function findComponentByEl(el, strict = true) {
        let componentId = walkUpwards(el, (node, { stop }) => {
            ...
            let endMarkers = [];
            let slotParentId = walkBackwards(
                node,
                (siblingNode, { stop: stop2 }) => {
                    if (isEndFragmentMarker(siblingNode)) {
                        let metadata =
                            extractFragmentMetadataFromMarkerNode(siblingNode);
                    ...
                    if (getTabIndex(state.mostRecentlyFocusedNode) > 0) {
                        ...
                        if (tabbableNodes.length > 0) {
                            var mruTabIdx = tabbableNodes.findIndex(
                                function (node) {
                                    return (
                                        node === state.mostRecentlyFocusedNode
                                    );
                                },
                            );
                            if (mruTabIdx >= 0) {
        ...
        trap = {
            ...
            activate: function activate(activateOptions) {
                ...
                if (preexistingTrap && !preexistingTrap.paused) {
                    ...
                    (_preexistingTrap$_set =
                        preexistingTrap._setSubtreeIsolation) === null ||
                ...
                try {
                    ...
                    if (
                        preexistingTrap ===
                            activeFocusTraps.getActiveTrap(trapStack) &&
                        revertState
                    ) {
                        var _preexistingTrap$_set2;
                        (_preexistingTrap$_set2 =
                            preexistingTrap._setSubtreeIsolation) === null ||
            ...
            Alpine27.skipDuringClone(
                (
                    ...
                    let options = {
                        ...
                        threshold,
                        root: modifiers.includes('parent')
                            ? el.parentElement
                            : null,
                    };
    ...
    function observeForDwell(
        ...
        let completeDwell = () => {
            ...
            if (
                !lastEntry ||
                document.hidden ||
                !meetsDwellThreshold(lastEntry, value, threshold)
            )
                return;
            hasEvaluated = true;
            evaluate2();
        ...
        let confirmDwell = () => {
            ...
            if (
                pendingEntries.some(
                    (entry) => !meetsDwellThreshold(entry, value, threshold),
                )
            ) {
    ...
    function _ghostIsFirst(evt, vertical, sortable) {
        ...
        return vertical
            ? evt.clientX < childContainingRect.left - spacer ||
                  (evt.clientY < firstElRect.top &&
                      evt.clientX < firstElRect.right)
            : evt.clientY < childContainingRect.top - spacer ||
                  (evt.clientY < firstElRect.bottom &&
                      evt.clientX < firstElRect.left);
    }
    function _ghostIsLast(evt, vertical, sortable) {
        ...
        return vertical
            ? evt.clientX > childContainingRect.right + spacer ||
                  (evt.clientY > lastElRect.bottom &&
                      evt.clientX > lastElRect.left)
            : evt.clientY > childContainingRect.bottom + spacer ||
                  (evt.clientX > lastElRect.right &&
    ...
    function src_default5(Alpine27) {
        Alpine27.directive(
            ...
            (
                el,
                { value, modifiers, expression },
                { effect, evaluate: evaluate2, cleanup },
            ) => {
                if (value === 'config') {
                    return;
                }
                ...
                let preferences = {
                    ...
                    useHandles:
                        ...
                        Array.from(
                            el.querySelectorAll('template:not(svg template)'),
                        ).some((tmpl) =>
                            tmpl.content?.querySelector(handleSelector),
                        ),
                    group: getGroupName(el, modifiers),
                };
                let handleSort = generateSortHandler(expression, evaluate2);
                let config = getConfigurationOverrides(
                    el,
                    modifiers,
                    evaluate2,
                );
            ...
            Alpine27.skipDuringClone(
                (
                    ...
                    let off2 = modifiers.includes('document')
                        ? onDocumentResize(evaluate2)
                        : onElResize(el, evaluate2);
                    cleanup(() => off2());
                },
            ),
        );
        ...
        Alpine27.directive(
            ...
            Alpine27.skipDuringClone(
                (
                    ...
                    { evaluate: evaluate2, effect, cleanup },
                ) => {
                    let {
                        placement,
                        offsetValue,
                    ...
                    effect(() => {
                        ...
                        if (previousReference !== reference) {
                            ...
                            release = autoUpdate(reference, el, () =>
                                compute(),
                            );
                        }
                    });
        ...
        writeToHistory(method, url, callback) {
            ...
            try {
                ...
                Object.values(this.errorHandlers).forEach(
                    (handler) =>
                        typeof handler === 'function' && handler(error2, url),
                );
                this.errorHandlers = {};
                console.error(error2);
            }
    ...
    function updateUrl(method, url, html) {
        ...
        coordinator_default[method](url, {
            snapshotIdx: key,
            url: url.toString(),
        });
    ...
    function linkShouldBeHandledNatively(
        linkEl,
        destination = extractDestinationFromLink(linkEl),
    ) {
    ...
    function startNavigation() {
        ...
        let navigation = new Navigation(() => {
            if (activeNavigation === navigation) activeNavigation = void 0;
        });
    ...
    var Navigation = class {
        ...
        complete() {
            Object.values(this.listeners).forEach((listeners2) =>
                listeners2.clear(),
            );
            this.onComplete();
        }
        ...
        function navigateTo(
            ...
            fetchHtmlOrUsePrefetchedHtml(
                        ...
                        (andAfterAllThis) => {
                            ...
                            swapCurrentPageWithNewHtml(
                                ...
                                (afterNewScriptsAreDoneLoading) => {
                                    ...
                                    swapCallbacks.forEach((callback) =>
                                        callback(),
                                    );
                                    afterNewScriptsAreDoneLoading(() => {
                                        andAfterAllThis(() => {
                ...
                (error2) => {
                    navigation.cancel();
                    showProgressBar && finishAndHideProgressBar();
                    if (requestWasCancelled(error2)) return;
            ...
            (ifThePageBeingVisitedHasntBeenCached) => {
                ifThePageBeingVisitedHasntBeenCached((url) => {
                    ...
                    navigateTo(destination, {
                        shouldPushToHistoryState: false,
                    });
                });
            },
    ...
    function fromQueryString(search, queryKey) {
        ...
        entries.forEach(([key, value]) => {
            ...
            let shouldBeHandledAsArray =
                decodedKey.includes('[') &&
                (dotNotatedKey === queryKey ||
                    dotNotatedKey.startsWith(`${queryKey}.`));
    ...
    function morphBetween(startMarker, endMarker, toHtml, options = {}) {
        ...
        if (window.Alpine && window.Alpine.closestDataStack) {
            toContainer._x_dataStack =
                window.Alpine.closestDataStack(fromContainer);
            toContainer._x_dataStack &&
    ...
    function createMorphContext(options = {}) {
        ...
        context.patch = function (from, to) {
            ...
            let skipUntil = (predicate) =>
                (context.skipUntilCondition = predicate);
            if (
                shouldSkipChildren(
                    context.updating,
                    () => (skipChildren = true),
        ...
        context.patchChildren = function (from, to) {
            ...
            while (currentTo) {
                ...
                if (context.skipUntilCondition) {
                    ...
                    let toDone =
                        !currentTo || context.skipUntilCondition(currentTo);
                    if (fromDone && toDone) {
                        ...
                        if (!fromDone)
                            currentFrom =
                                currentFrom &&
                                getNextSibling(from, currentFrom);
                        if (!toDone)
                            currentTo =
                ...
                if (
                    ...
                    while (!found && nextToElementSibling) {
                        if (
                            ...
                            found = true;
                            currentFrom = context.addNodeBefore(
                                from,
                                currentTo,
                                currentFrom,
                            );
                ...
                if (currentFrom._x_lastRenderedEl) {
                    currentFromNext = getNextSibling(
                        from,
                        currentFrom._x_lastRenderedEl,
                    );
                }
    ...
    function src_default9(Alpine27) {
        Alpine27.directive(
            'mask',
            (el, { value, expression }, { effect, evaluateLater, cleanup }) => {
        ...
        import_alpinejs9.default.onAttributesAdded((el, attributes) => {
            ...
            attributes.forEach((attribute) => {
                ...
                trigger('directive.init', {
                    ...
                    directive: directive2,
                    cleanup: (callback) => {
                        import_alpinejs9.default.onAttributeRemoved(
                            el,
                            directive2.raw,
                            callback,
                        );
            ...
            import_alpinejs9.default.skipDuringClone(
                (el) => {
                    ...
                    if (
                        ...
                        if (treeIsSuspendedFor(component2)) return;
                    }
    ...
    on('effect', ({ component, effects }) => {
        let listeners2 = [];
        if (
            Object.prototype.hasOwnProperty.call(effects, 'listeners') &&
            effects.listeners
        ) {
    ...
    interceptMessage(({ message, onSuccess }) => {
        onSuccess(({ payload, onMorphed }) => {
            onMorphed(() =>
                evaluateJsEffects(message.component, payload.effects),
            );
        });
    });
    ...
    `;
        ...
        let skipOnTopLayer = (transition) => {
            ...
            let onBeforeToggle = (event) => {
                if (
                    event.newState === 'open' &&
                    event.target.matches?.('dialog, [popover]')
                ) {
    ...
    async function morph2(component, el, html) {
        ...
        el.querySelectorAll('[wire\\:id]').forEach((component2) => {
            existingComponentsMap[component2.getAttribute('wire:id')] =
                component2;
        });
        ...
        await transitionDomMutation(
            ...
            to,
            () => {
                import_alpinejs12.default.morph(
                    el,
                    to,
    ...
    async function morphFragment(component, startNode, endNode, toHTML) {
        ...
        try {
            parentComponent = parentElement
                ? findComponentByEl(parentElement)
                : null;
        } catch (e) {}
        if (parentComponent) {
            let parentProviderWrapper =
                document.createElement(parentElementTag);
        ...
        await transitionDomMutation(
            ...
            toContainer,
            () => {
                import_alpinejs12.default.morphBetween(
                    startNode,
                    endNode,
                    toContainer,
                    getMorphConfig(component),
                    ...
                    if (metadata.mode !== 'morph') {
                        skipUntil((node) => {
                            if (isEndFragmentMarker(node)) {
                                ...
                                return (
                                    endMarkerMetadata.token === metadata.token
                                );
                            }
                            return false;
                        });
        ...
        onSuccess(({ payload, onMorph }) => {
            onMorph(async () => {
                ...
                if (
                    ...
                    payload.effects.islandFragments
                ) {
    ...
    async function renderIsland(component, islandHtml) {
        ...
        let parentElementTag = getTagName(
            fragment.startMarkerNode.parentElement,
        );
    ...
    function shouldMarkDisabled(el) {
        ...
        if (
            tag === 'input' &&
            inputTypesThatDontSupportReadonly.includes(el.type)
        )
            return true;
        return false;
    }
    ...
    on('effect', ({ component, effects, cleanup }) => {
        ...
        Object.entries(queryString).forEach(([key, value]) => {
            ...
            if (use === 'replace') {
                ...
                cleanup(() =>
                    import_alpinejs14.default.release(effectReference),
                );
            } else if (use === 'push') {
        ...
        onStream(({ json }) => {
            ...
            if (type === 'directive') {
                ...
                if (replaceEl) {
                    ...
                    targetEl = component.el.querySelector(
                        `[wire\\:stream="${name}"]`,
                    );
                }
            } else if (type === 'ref') {
    ...
    on('effect', ({ effects, request }) => {
        if (
            !Object.prototype.hasOwnProperty.call(effects, 'redirect') ||
            !effects['redirect']
        )
            return;
        let preventDefault = false;
    ...
    interceptMessage(({ message, onSend, onSuccess, onFinish }) => {
        ...
        releaseAfterNavigation({ onSuccess, onFinish }, () =>
    ...
    var attributeMap = {
        ...
        'wire:navigate.hover.preserve-scroll':
            'x-navigate.hover.preserve-scroll',
    };
    ...
    import_alpinejs16.default.interceptInit(
        import_alpinejs16.default.skipDuringClone((el) => {
            for (let [wireAttr, alpineDirective] of Object.entries(
                attributeMap,
            )) {
    ...
    interceptMessage(({ message, onSuccess }) => {
        onSuccess(({ onSync, onMorph, onRender }) => {
            message.actions.forEach((action) => {
                ...
                if (!directive2.modifiers.includes('preserve-scroll')) return;
                let oldHeight;
                let oldScroll;
                onSync(() => {
    ...
    on('directive.init', ({ el, directive: directive2 }) => {
        if (!directive2.rawName.startsWith('wire:sort:item')) return;
        if (el._x_sort_key !== void 0) return;
            ...
            if (el.attributes[i].name.startsWith('wire:sort:item')) {
                ...
                import_alpinejs18.default.bind(el, {
                    [attribute]() {
                        ...
                        let position =
                            itemPosition !== -1 ? itemPosition : this.$position;
    ...
    on('effect', ({ component, effects }) => {
        if (
            Object.prototype.hasOwnProperty.call(effects, 'styleModule') &&
            effects.styleModule
        ) {
    ...
    on(
        'directive.init',
        ({ el, directive: directive2, cleanup, component }) => {
            if (
                [
                    'snapshot',
                    'effects',
                    ...
                    let execute = () => {
                        callAndClearComponentDebounces(component, () => {
                            ...
                            if (livewireOptions?.interceptAction) {
                                setNextActionInterceptor(
                                    livewireOptions.interceptAction,
                                );
                            }
                            let expression = directive2.expression;
                            if (
    ...
    directive(
        'loading',
        ({ el, directive: directive2, component, cleanup }) => {
            ...
            let startLoading = () => {
                if (activeLoadingCount === 0) {
                    if (directive2.modifiers.includes('class')) {
                        let classes = directive2.expression
                            .split(' ')
                            .filter(String);
                        let classStates = classes.map((className) => [
                            className,
                            el.classList.contains(className),
                        ]);
                        restoreLoadingState = () =>
                            classStates.forEach(([className, wasPresent]) => {
    ...
    import_alpinejs20.default.interceptInit((el) => {
        if (el.hasAttribute('wire:cloak')) {
            import_alpinejs20.default.mutateDom(() =>
                el.removeAttribute('wire:cloak'),
            );
        }
    });
    ...
    directive('model', ({ el, directive: directive2, component, cleanup }) => {
        ...
        if (shouldSendNetwork && networkOnBlur) {
            bindings['@blur'] = () => {
                queueMicrotask(() => {
                    let target = expression.startsWith('$parent')
                        ? component.parent
                        : component;
    ...
    function getModifierTail(modifiers) {
        ...
        if (modifiers.includes('debounce')) {
            ...
            let hasDuration =
                parseModifierDuration(modifiers, 'debounce') !== void 0;
            modifiers.splice(index2, hasDuration ? 2 : 1);
        }
        if (modifiers.includes('throttle')) {
            let index2 = modifiers.indexOf('throttle');
            let hasDuration =
                parseModifierDuration(modifiers, 'throttle') !== void 0;
            modifiers.splice(index2, hasDuration ? 2 : 1);
        }
    ...
    function parseModifierDuration(modifiers, key) {
        ...
        let nextModifier =
            modifiers[modifiers.indexOf(key) + 1] || 'invalid-wait';
    ...
    directive('init', ({ component, el, directive: directive2 }) => {
        let fullMethod = directive2.expression
    ...
    function extractDurationFrom(modifiers, defaultDuration) {
        ...
        let durationInMinutesString = modifiers.find((mod) =>
            mod.match(/([0-9]+)m/),
        );
        if (durationInMilliSecondsString) {
            ...
            durationInMilliSeconds =
                Number(durationInMinutesString.replace('m', '')) * 60 * 1e3;
        }
